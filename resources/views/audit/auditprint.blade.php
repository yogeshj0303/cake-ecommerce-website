...
<tr class="table-row">
    ...
    <td class="table-cell">{{ $user->audit_name ?? '- -' }}</td>
</tr>
    ...
    <tr class="table-row">
        ...
        <td class="table-cell">{{ $user->audit_remark ?? '- -' }}</td>
    </tr>
    <tr class="table-row">
        <td class="table-cell">{{ $rowNumber++ }}</td>
        <td class="table-cell" style="font-weight: bold;">Auditor Name</td>
        <td class="table-cell">{{ $user->auditor_name ?? '- -' }}</td>
    </tr>
    <tr class="table-row">
        <td class="table-cell">{{ $rowNumber++ }}</td>
    ...
    <tr class="table-row">
        ...
        <td class="table-cell">{{ $user->organisation_name ?? '- -' }}</td>
    </tr>

  <tr class="table-row">
        <td class="table-cell">{{ $rowNumber++ }}</td>
        <td class="table-cell" style="font-weight: bold;">Auditor Verification Description</td>
        <td class="table-cell">{{ $user->auditor_veri_des ?? '- -' }}</td>
    </tr>
