...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
            <button type="button" class="btn btn-primary me-2" onclick="window.location.href='{{ route('draft.create') }}'">Forward</button>
            <button type="button" class="btn btn-info me-2"    onclick="window.location.href='{{ route('volume') }}'">Create Volume</button>
            <div class="dropdown">
