...
<div class="col-xxl-7">
    <div class="card">
        <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">Department</h4>
             <a href="{{route('departments.showdata')}}" ><button class="btn btn-sm btn-primary mx-2 " data-id="">
    ...
    <td>{{  $department->id }}</td>
                                <td class="departmentName">{{ $department->name }}</td>
                                            <td class="statename">{{ $department->state }}</td>
            <td class="districtname">{{ $department->district }}</td>
            <td class="taluka">{{ $department->taluka }}</td>
            <td class="organisation">{{ $department->org_name }}</td>

                                <td style="display:flex">
                                   
                                    @if((isset($permissions)) && (($permissions['department_edit'] == 2)))
                                    <button class="btn btn-sm btn-primary mx-2 editDepartment" data-id="{{ $department->id }}">
                                        <i class="fa fa-edit"></i> Edit
                                    </button>
                                    @endif
                                    @if((isset($permissions)) && ( ($permissions['department_delete'] == 2)))
                                    <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal" data-id="{{ $department->id }}">
                                       Remove
                                    </button>
                                    @endif
