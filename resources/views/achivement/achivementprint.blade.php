...
<tr class="table-row">
    ...
    <td class="table-cell">{{ $user->achivementname ?? '- -' }}</td>
</tr>
...
<tr class="table-row">
    ...
    <td class="table-cell" colspan="2" style="padding: 10px 0 10px 10px;">
        ...
        <div style="font-size: 14px; color: #333; line-height: 1.6;">
            {!! strip_tags($user->achivement_memo, '<b><i><u><strong><em><br>') !!}
        </div>
    </td>
</tr>
