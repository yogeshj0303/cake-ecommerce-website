...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="leave-form"id="achievement" method="POST" action="{{ route('updateachievement', $achievement->id) }}" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="achivement_name" id="achivementName" class="form-select mb-3">
                                ...
                                @foreach($achivements as $achivement)
                                    <option value="{{ $achivement->id }}" {{ $achievement->achivement_name == $achivement->id ? 'selected' : '' }}>{{ $achivement->name }}</option>
                                @endforeach
                            </select>
                            @error('achivement_name')
                                <div class="invalid-feedback" style="color: red;">
                                    {{ $message }}
                                </div>
                            @enderror
 ...
 <div class="row" id="memoField">
    <div class="form-group col-md-12">
        ...
        <div id="memo-editor" contenteditable="true" style="border: 1px solid #ccc; height: 200px; overflow-y: auto; padding: 10px;">
            {!! old('achivement_memo', $achievement->achivement_memo) !!}
        </div>
        <textarea id="memo" name="achivement_memo" style="display:none;">{!! old('achivement_memo', $achievement->achivement_memo) !!}</textarea>
    </div>
</div>
   ...
   <div class="row mb-3">
    <div class="col-md-12">
        ...
        @enderror
                    ...
                    <!--            <img id="hod-signature-preview" src="{{ asset('images/'.$achievement->hod_signature) }}" alt="HOD Signature Preview" style="max-width: 200px; margin-top: 10px;" />-->
                    <!--        @endif-->
                    <!--        @error('hod_signature')-->
                    <!--            <div class="invalid-feedback text-red">{{ $message }}</div>-->
                    <!--        @enderror-->
                    ...
                    <!--            <img id="clerk-signature-preview" src="{{ asset('images/'.$achievement->clerk_signature) }}" alt="Clerk Signature Preview" style="max-width: 200px; margin-top: 10px;" />-->
                    <!--        @endif-->
