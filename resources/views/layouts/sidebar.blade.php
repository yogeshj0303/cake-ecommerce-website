...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="index" class="logo logo-dark">
            ...
            <span class="logo-lg">
                <img src="{{ URL::asset('build/images/logo-dark.png') }}" width="170px" height="auto">
            </span>
        </a>
        <!-- Light Logo-->
        <a href="index" class="logo logo-light">
            ...
            <span class="logo-lg">
                <img src="{{ URL::asset('build/images/logo-light.png') }}" alt="" width="170px" height="auto">
            </span>
        </a>
...
<a href="/index" class="nav-link">Dashboard</a>
                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebardepart">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('departments.index')}}" class="nav-link">View Department
                                </a>
                            </li>
                   ...
                   <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebardesignation">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('designations.index')}}" class="nav-link">View Designation
                                </a>
                            </li>
                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarchecklist">
                        <ul class="nav nav-sm flex-column">
                             ...
                             @if((isset($permissions)) && (($permissions['receipt_master_view'] == 2)||($permissions['receipt_master_create'] == 2)
                            ||($permissions['receipt_master_edit'] == 2)||($permissions['receipt_master_delete'] == 2)))
                            <li class="nav-item">
                                <a href="{{ route('checklists.index')}}" class="nav-link"> Receipt Master
                                </a>
                            </li>
                            @endif
                            @if((isset($permissions)) && (($permissions['checklist_master_view'] == 2)||($permissions['checklist_master_create'] == 2)
                             ||($permissions['checklist_master_edit'] == 2)||($permissions['checklist_master_delete'] == 2) ))
                             <li class="nav-item">
                                <a href="{{ route('checklist-master.index')}}" class="nav-link"> Checklist Master
                                </a>
                            </li>
                           @endif
                            @if((isset($permissions)) && (($permissions['tehsils_view'] == 2)||($permissions['tehsils_create'] == 2)
                            ||($permissions['tehsils_edit'] == 2)||($permissions['tehsils_delete'] == 2)))
                             <li class="nav-item">
                                <a href="{{url('tehshil')}}" class="nav-link">Tehsil
                                </a>
                            </li>
                            @endif
                             @if((isset($permissions)) && (($permissions['document_master_view'] == 2)||($permissions['document_master_create'] == 2)
                             ||($permissions['document_master_edit'] == 2)||($permissions['document_master_delete'] == 2)))
                              <li class="nav-item">
                                <a href="{{url('document')}}" class="nav-link">Documents
                                </a>
                            </li>
                            @endif
                             @if((isset($permissions)) && (($permissions['organizations_master_view'] == 2)||($permissions['organizations_master_create'] == 2)
                             ||($permissions['organizations_master_edit'] == 2)||($permissions['organizations_master_delete'] == 2) ))
                            <li class="nav-item">
                                <a href="{{url('organization')}}" class="nav-link">Organizations
                                </a>
                            </li>
                            @endif
                             @if((isset($permissions)) && (($permissions['leave_category_view'] == 2)||($permissions['leave_category_create'] == 2)
                             ||($permissions['leave_category_edit'] == 2)||($permissions['leave_category_delete'] == 2)))
                            
                             <li class="nav-item">
                                <a href="{{ route('leaves_type')}}" class="nav-link"> Leave category
                                </a>
                            </li>
                            @endif
                             @if((isset($permissions)) && (($permissions['nomination_type_view'] == 2)||($permissions['nomination_type_create'] == 2)
                             ||($permissions['nomination_type_edit'] == 2)||($permissions['nomination_type_delete'] == 2)))
                                  <li class="nav-item">
                                <a href="{{ route('nomination_type')}}" class="nav-link"> Nomination type 
                                </a>
                            </li>
                            @endif
                             @if((isset($permissions)) && (($permissions['achievement_type_view'] == 2)||($permissions['achievement_type_create'] == 2)
                             ||($permissions['achievement_type_edit'] == 2)||($permissions['achievement_type_delete'] == 2)))
                                   <li class="nav-item">
                                <a href="{{ route('achievements.index')}}" class="nav-link"> Achievement category
                                </a>
                            </li>
                            @endif
                             @if((isset($permissions)) && (($permissions['affidavit_type_view'] == 2)||($permissions['affidavit_type_create'] == 2)
                             ||($permissions['affidavit_type_edit'] == 2)||($permissions['affidavit_type_delete'] == 2)))
                            <li class="nav-item">
                                <a href="{{ route('affidavits.index')}}" class="nav-link"> Affidavit category
                                </a>
                            </li>
                             @endif
                           </ul>
                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarleaves">
                        <ul class="nav nav-sm flex-column">
                           ...
                           <li class="nav-item">
                                <a href="{{route('staff-add.index')}}" class="nav-link">Staff Selection
                                </a>
                            </li>
                            @endif
                             @if((isset($permissions)) && (($permissions['role_view'] == 2) || ($permissions['role_create'] == 2)
                             || ($permissions['role_edit'] == 2) || ($permissions['role_delete'] == 2) ))
                             <li class="nav-item">
                                <a href="{{route('roles.index')}}" class="nav-link">Add Roles
                                </a>
                            </li>
                            @endif
                             @if((isset($permissions)) && (($permissions['permission_view'] == 2) || ($permissions['permission_create'] == 2) 
                             || ($permissions['permission_edit'] == 2) || ($permissions['permission_delete'] == 2)))
                            <li class="nav-item">
                                <a href="{{route('rolespermission.index')}}" class="nav-link">Assign Permissions
                                </a>
                            </li>
                            @endif
                        </ul>
    ...
    ($permissions['achievement_view'] == 2) || ($permissions['achievement_create'] == 2) || ($permissions['achievement_edit'] == 2) || ($permissions['achievement_delete'] == 2)
                    ...
                    <a class="nav-link menu-link" href="#sidebaruserprofile" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebaruserprofile">
                        <i class="mdi mdi-account-circle"></i> <span>Details
                        </span>
                    </a>
    ...
    || ($permissions['userprofile_edit'] == 2) || ($permissions['userprofile_delete'] == 2) ))
                            <li class="nav-item">
                                <a href="{{ route('users.index')}}" class="nav-link"> User Profile
                                </a>
                            </li>
                            @endif
                                @if((isset($permissions)) && (($permissions['userdetail_view'] == 2) || ($permissions['userdetail_create'] == 2) 
                                || ($permissions['userdetail_edit'] == 2) || ($permissions['userdetail_delete'] == 2)  ))
                             <li class="nav-item">
                                <a href="{{ route('user-details-view')}}" class="nav-link"> User Details
                                </a>
                            </li>
                            @endif
                                @if((isset($permissions)) && (($permissions['document_view'] == 2) || ($permissions['document_create'] == 2)
                                || ($permissions['document_edit'] == 2) || ($permissions['document_delete'] == 2)))
                             <li class="nav-item">
                                <a href="{{ route('documents.index')}}" class="nav-link"> Document Details
                                </a>
                            </li>
                           @endif
                               @if((isset($permissions)) && (($permissions['leave_view'] == 2) || ($permissions['leave_create'] == 2) 
                               || ($permissions['leave_edit'] == 2) || ($permissions['leave_delete'] == 2)))
                             <li class="nav-item">
                                <a href="{{ route('leaves.index')}}" class="nav-link"> Leave Details
                                </a>
                            </li>
                            @endif
                                @if((isset($permissions)) && (($permissions['nomination_view'] == 2) || ($permissions['nomination_create'] == 2) 
                                || ($permissions['nomination_edit'] == 2) || ($permissions['nomination_delete'] == 2)))
                            <li class="nav-item">
                                <a href="{{ route('nomination-index')}}" class="nav-link"> Nomination Details
                                </a>
                            </li>
                            @endif
                                @if((isset($permissions)) && (($permissions['salary_view'] == 2) || ($permissions['salary_create'] == 2)
                                || ($permissions['salary_edit'] == 2) || ($permissions['salary_delete'] == 2) ))
                            <li class="nav-item">
                                <a href="{{ route('salary.index')}}" class="nav-link"> Salary Details
                                </a>
                            </li>
                            @endif
                                @if((isset($permissions)) && (($permissions['checklist_view'] == 2) || ($permissions['checklist_create'] == 2) 
                                || ($permissions['checklist_edit'] == 2) || ($permissions['checklist_delete'] == 2)))
                                                        <li class="nav-item">
                                <a href="{{ route('checklist-new.index')}}" class="nav-link"> Checklist
                                </a>
                            </li>
                            @endif
                                @if((isset($permissions)) && (($permissions['trans_join_view'] == 2) || ($permissions['trans_join_create'] == 2) 
                                || ($permissions['trans_join_edit'] == 2) || ($permissions['trans_join_delete'] == 2)))
                                                        <li class="nav-item">
                                <a href="{{ route('transfer.index')}}" class="nav-link">Transfer & Joining Order
                                </a>
                            </li>
                            @endif
                                @if((isset($permissions)) && (($permissions['other_receipt_view'] == 2) || ($permissions['other_receipt_create'] == 2)
                                || ($permissions['other_receipt_edit'] == 2) || ($permissions['other_receipt_delete'] == 2)))
                        <li class="nav-item">
                                <a href="{{ route('receipts.index')}}" class="nav-link">Other's receipt
                                </a>
                            </li>
                            @endif
                                @if((isset($permissions)) && (($permissions['affidavit_view'] == 2) || ($permissions['affidavit_create'] == 2) 
                                || ($permissions['affidavit_edit'] == 2) || ($permissions['affidavit_delete'] == 2) ))
                                                         <li class="nav-item">
                                <a href="{{ route('getaffidavit')}}" class="nav-link">Affidavit
                                </a>
                            </li>
                            @endif
                                @if((isset($permissions)) && (($permissions['achievement_view'] == 2) || ($permissions['achievement_create'] == 2) 
                                || ($permissions['achievement_edit'] == 2) || ($permissions['achievement_delete'] == 2)))
                                                         <li class="nav-item">
                                <a href="{{ route('getahievement')}}" class="nav-link">Achievement
                                </a>
                            </li>
                         @endif
                                @if((isset($permissions)) && (($permissions['achievement_view'] == 2) || ($permissions['achievement_create'] == 2) 
                                || ($permissions['achievement_edit'] == 2) || ($permissions['achievement_delete'] == 2)))
                                                         <li class="nav-item">
                                <a href="{{ route('audits.index')}}" class="nav-link">Audit
                                </a>
                            </li>
                         @endif
                           @if((isset($permissions)) && (($permissions['achievement_view'] == 2) || ($permissions['achievement_create'] == 2) 
                ...
                <!--                    <ul class="nav nav-sm flex-column">-->
                <!--                        <li class="nav-item">-->
                <!--                            <a href="{{ route('draft.index')}}" class="nav-link">Drafts-->
                <!--                            </a>-->
                <!--                        </li>-->
                <!--                        <li class="nav-item">-->
                <!--                            <a href="{{ route('complete.index')}}" class="nav-link">Completed-->
                <!--                            </a>-->
                <!--                        </li>-->
                ...
                <!--            <li class="nav-item">-->
                <!--                <a href="{{ route('parked.index')}}" class="nav-link" >Parked-->

                <!--                </a>-->
                                
                <!--            </li>-->
                <!--            <li class="nav-item">-->
                <!--                <a href="{{ route('closed.index')}}" class="nav-link">Closed-->
                <!--                </a>-->
                <!--            </li>-->
                            <!--<li class="nav-item">-->
                ...
                <!--                    <ul class="nav nav-sm flex-column">-->
                                        ...
                                        <!--</li>-->
                <!--                        <li class="nav-item">-->
                <!--                            <a href="{{ route('sfs-physical.create')}}" class="nav-link">Create New-->
                <!--                            </a>-->
                <!--                        </li>-->
                                        <!--  <li class="nav-item">-->
                ...
                <!--                    <ul class="nav nav-sm flex-column">-->
                                        ...
                                        <!--</li>-->
                <!--                        <li class="nav-item">-->
                <!--                            <a href="{{ url('view-electronic-file')}}" class="nav-link">Create New-->
                <!--                            </a>-->
                <!--                        </li>-->
                                        <!--<li class="nav-item">-->
                                        <!--    <a href="apps-tasks-kanban" class="nav-link">Create Shadow File(Non SFS)-->
                ...
                <!--                    <ul class="nav nav-sm flex-column">-->
                <!--                        <li class="nav-item">-->
                <!--                            <a href="/createpartt" class="nav-link">@lang('translation.transactions')-->
                <!--                            </a>-->
                <!--                        </li>-->
                                        <!--<li class="nav-item">-->
                ...
                <!--                    <ul class="nav nav-sm flex-column">-->
                <!--                        <li class="nav-item">-->
                <!--                            <a href="/createvolumeindex" class="nav-link">@lang('translation.list-view')-->
                <!--                            </a>-->
                <!--                        </li>-->
                                        <!--<li class="nav-item">-->
