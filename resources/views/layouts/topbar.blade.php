        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        ...
                        <span class="logo-lg">
                            <img src="{{ URL::asset('build/images/logo-light.png') }}" width="170px" height="auto">
                        </span>
                    </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                  ...
                  <img src="{{asset('build/icons/user.png')}}" alt="User Image" style="width: 40px;">
                    </div>
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ strtoupper(Auth::user()->first_name) }}</span>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{ strtoupper(Auth::user()->is_admin) }}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome {{ strtoupper(Auth::user()->first_name) }}!</h6>
                        <a class="dropdown-item" href="{{ route('Userprofilepage')}}"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
