        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!--<form action="{{ route('receipts.update' , $letter->id)}}" method="POST" enctype="multipart/form-data" id="mainform">-->
                        @csrf
                        @method('PUT')
...
<div class="elebtn" style="display: flex; align-items: center; gap: 10px;">
    @if($letter->status == 'pending' || $letter->status == 'rejected')
    ...
    @if (strpos(strtolower($letter->letter_content), '.pdf') !== false)
    
    
        <iframe src="{{ asset('images/' . basename($letter->letter_content)) }}" width="100%" height="400px"></iframe>
    ...
    ->first();?>
                        ...
                        <input type="text" id="state" name="state" class="form-control" value="{{ $user_data->state}}" readonly>
                       </div>
                   
                        <div class="form-group">
                        <label for="district">District</label>
                        <input type="text" id="district" name="district" class="form-control" value="{{ $user_data->district }}" readonly>
                    </div>
                        ...
                        <input type="text" id="organisation" name="org_id" class="form-control" value="{{$user_data->org_name}}" readonly>
                    </div>

                                <div class="form-group">
                        <label for="department_name"> Department</label>
                        <input type="text" id="department_name" name="department_name" class="form-control" value="{{$user_data->department_name}}" readonly>
                    </div>
     
                                <div class="form-group">
                        <label for="taluka">Taluka</label>
                        <input type="text" id="taluka" name="taluka" class="form-control" value="{{$user_data->taluka}}" readonly>
                    </div>
                   
                                <div class="form-group">
                        <label for="designation" >Designation</label>
                        <input type="text" id="designation" name="designation" class="form-control" value="{{$user_data->designation_name}}" readonly>
                    </div>
                        <div class="form-group">
                        <label for="designation" >Receipt NO</label>
                        <input type="text" id="receipt_no"  class="form-control" value="{{$letter->receipt_no}}" readonly>
                    </div>
                        <div class="form-group">
                        <label for="designation" >Receipt Category </label>
                        <input type="text" id="receipt_checklist_id" class="form-control" value="{{$letter->receipt_checklist_id}}" readonly>
                    </div>
                        <div class="form-group">
                        <label for="designation" >Subject</label>
                        <input type="text" id="subject" class="form-control" value="{{$letter->subject}}" readonly>
                    </div>
                ...
                <form action="{{ route('otherdetails.updateStatus', $letter->id) }}" id="achievement-form" method="POST">
    ...
    <div class="row">
        <div class="col-md-12 mb-3" style="margin-top:12px;">
            @if(($letter->status =='pending' || ($letter->status == 'approved_clerk' && $letter->frwd_hod_id == Auth::user()->id )) && Auth::user()->is_admin == 'staff' )
          
            <!-- Approve Button -->
              <button type="button" id="send-button" class="btn btn-primary me-2" data-docuser="{{$letter->id}}">Send</button>

              
            <button type="button" id="approve-button" class="btn btn-success me-2" data-docuser ="{{$letter->id}}" >Send & Sign</button>

            <!-- Reject Button -->
            <button type="button" id="reject-button" class="btn btn-danger">Reject</button>
             @elseif(($letter->status == 'pending' || $letter->status == 'approved_clerk') && Auth::user()->is_admin != 'staff')
            ...
            <div class="modal-body">
                <!--<form id="frwd_to_staff_Form"> -->
                    <div class="form-group">
                        ...
                        <input type="hidden" name="frwd_leave_id" value="{{ $letter->id }}" id="frwd_leave_id">
