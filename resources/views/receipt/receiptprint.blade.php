...
<tr class="table-row">
    ...
    <td class="table-cell">{{ $user->receipt_checklist_id ?? '- -' }}</td>
</tr>

<tr class="table-row">
    <td class="table-cell">{{ $rowNumber++ }}</td>
    <td class="table-cell" style="font-weight: bold;">Receipt Number</td>
    <td class="table-cell">{{ $user->receipt_no ?? '- -' }}
...
<tr class="table-row">
    ...
    <td class="table-cell">{{ $user->subject ?? '- -' }}
...
<tr class="table-row">
    ...
    <td class="table-cell">{{ $user->description ?? '- -' }}
...
<tr class="table-row">
    ...
    <td class="table-cell" colspan="2" style="padding: 10px 0 10px 10px;">
        ...
        <div style="font-size: 14px; color: #333; line-height: 1.6;">
            {!! strip_tags($user->letter_content, '<b><i><u><strong><em><br>') !!}
        </div>
    </td>
</tr>
