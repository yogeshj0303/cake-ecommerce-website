            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="contact" name="contact" class="form-control" value="{{ $user->number }}" readonly />
                    </div>
                    <div class="col-md-4">
                        <label for="birth_date" class="form-label">Birth Date</label>
                        <input type="text" id="birth_date" name="birth_date" class="form-control" value="{{ $user->birth_date }}" readonly />
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="leaves" name="leaves" class="form-control" value="{{ $user->leaves }}" readonly />
                </div>
                <div class="mb-3">
                    <label for="leaves" class="form-label">available leave</label>
                    <input type="number" id="leaves" name="leaves" class="form-control" value="{{ $user->available_leave }}" readonly />
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if($user->old_book)
                        <a href="{{ asset('images/' . $user->old_book) }}" target="_blank">View Uploaded Book</a>
                    @else
