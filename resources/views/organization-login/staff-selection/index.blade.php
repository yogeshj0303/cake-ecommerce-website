                        ...
                        <div class="row g-4 mb-3">
                            <div class="col-sm-auto">
                                <div>
                                   ...
                                   <a href="{{route('staff-add.create')}}"<button type="button" class="btn btn-success add-btn">
    Add
</button></a>
@endif
  <a href="{{route('staff.history')}}"<button type="button" class="btn btn-primary ">
    History
</button></a>
                                </div>
                            </div>
    ...
    <thead class="table-light">
        <tr>
            ...
            <th class="" data-sort="full_name">Staff Name</th>
            <th class="" data-sort="organisation_name">Organization</th>
            <th class="" data-sort="state">State</th>
            <th class="" data-sort="district">District</th>
            <th class="" data-sort="designation_name">Designation</th>
            <th class="" data-sort="role_name">Role</th>
            <th class="" data-sort="taluka">Taluka</th>
            <th class="" data-sort="phone_number">Phone Number</th>
            <th class="" data-sort="email">Email</th>
            <th class="" data-sort="password">Password</th>
    ...
    ($permissions['staff_delete'] == 2)
        ...
        @foreach ($staffs as $staff)
            <tr>                <td class="first_name">{{ $staff->id }}</td>

                <td class="first_name">{{ $staff->first_name }}  {{ $staff->middle_name }}  {{ $staff->last_name }}</td>
                <td class="organisation_name">{{ $staff->org_name }}</td>
                <td class="state">{{ $staff->state_name }}</td>
                <td class="district">{{ $staff->district_name }}</td>
                <td class="designation_name">{{ $staff->designation_name }}</td>
                <td class="role_name">{{ $staff->role_name }}</td>
                <td class="taluka">{{ $staff->taluka }}</td>
                <td class="phone_number">{{ $staff->number }}</td>
                <td class="email">{{ $staff->email }}</td>
                  <td class="password">{{ $staff->password_word }}</td>
                <td class="address">{{ $staff->address }}</td>
                @if((isset($permissions)) && (
    ($permissions['staff_edit'] == 2) || 
    ($permissions['staff_delete'] == 2)
))
                <td>
                    <div class="d-flex gap-2">
                        ...
                        <div class="edit">
                           <a href="{{route('staff-add.edit',$staff->id )}}"> <button type="button" class="btn btn-sm btn-primary edit-item-btn" >
                                Edit
                            </button></a>
                        </div>
                        @endif
                         <div class="show">
                           <a href="{{route('staff-add.show',$staff->id )}}"> <button type="button" class="btn btn-sm btn-success" >
                                view
                            </button></a>
                        </div>
                        ...
                        <div class="remove">
                            <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal" data-id="{{ $staff->id }}">
    Remove
</button>
@endif
                        </div>
