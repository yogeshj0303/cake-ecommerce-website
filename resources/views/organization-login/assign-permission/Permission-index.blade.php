  ...
  <meta name="csrf-token" content="{{ csrf_token() }}">
                        ...
                        <div class="row g-4 mb-3">
                            <div class="col-sm-auto">
                                <div>
                                   ...
                                   <a href="{{route('rolespermission.create')}}"<button type="button" class="btn btn-success add-btn">
                                            Add
                                        </button></a>
                                        @endif
                                        
                                        <a href="{{route('rolespermission.history')}}"<button type="button" class="btn btn-primary">
                                            History
                                        </button></a>
    ...
    ($permissions['permission_delete'] == 2)
        ...
        @foreach($rolepermissions as $rolePermission)
            <tr>
                            <td class="id">{{ $rolePermission->id }}</td>


                <td class="first_name">{{ isset($rolePermission->role_name) ? $rolePermission->role_name : 'N/A' }}</td>
                <td class="department_name">{{ isset($rolePermission->department_name) ? $rolePermission->department_name : 'N/A' }}</td>
                <td class="state">{{ isset($rolePermission->state_name) ? $rolePermission->state_name : 'N/A' }}</td>
                <td class="dist">{{ isset($rolePermission->district_name) ? $rolePermission->district_name : 'N/A' }}</td>
                <td class="taluka">{{ isset($rolePermission->taluka) ? $rolePermission->taluka : 'N/A' }}</td>
                <td class="contact">{{ isset($rolePermission->designation_name) ? $rolePermission->designation_name : 'N/A' }}</td>
                <td style="width:30px">
    ...
    ($permissions['permission_edit'] == 2) 
                           ...
                           <a href="{{route('rolespermission.edit',$rolePermission->id)}}" ><button type="button" class="btn btn-sm btn-primary edit-item-btn" >
                                Edit
                            </button></a>
                            @endif
                        </div>
    ...
    ($permissions['permission_delete'] == 2)
                            ...
                            <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal" data-id="{{ $rolePermission->id }}">
                                Remove
                            </button>
                            @endif
                        </div>
    ...
    ($permissions['permission_view'] == 2) 
                           ...
                           <a href="{{route('rolespermission.show',$rolePermission->id)}}" > <button type="button" class="btn btn-sm btn-success " >View </button></a>
                       @endif
                        </div>
                    </div>
                </td>
