                    ...
                    <div class="" id="">
                        <div class="row g-4 mb-3">
                            <div class="col-sm-auto">
                                <div>
                                        <a href="{{route('nomination-index')}}" > <button type="button" class="btn btn-primary " >
  back
</button></a>
                                </div>
                            </div>
...
<td>
  ...
  <div class="checkmark-container">
                                ...
                                @endif
                                @endif</td>
                               <!--<td>@if($item->hod_otp_status == 1 ) <div class="checkmark-container">-->
...
<!--                                              <button class="btn  edit-item-btn btn-sm btn-primary" onclick="window.location.href='{{ route('nomination.edit', $item->id) }}'">-->
<!--        Edit-->
<!--</button>-->
@endif
