...
@section('content')
   ...
   <div classs="row" style="display:flex;
        ...
        <div class="card" style=" width: 50%;
            padding: 0px 1px;
            background-color:#8fec776b;
            position: relative;
            height:300px;
            ">
            <form  action="{{ route('updategreennote' , $leaveuser->id )}}"id="greenNoteForm" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
...
<!--<input type="file" id="fileInput" name="upload_file" accept="application/pdf" />-->
        ...
        <div class="form-group col-md-12">
            ...
            <textarea id="memo" name="green_note_dis" style="display:none;"></textarea>
        </div>
    </div>
    ...
    height:300px;">
            ...
            <div class="elesec1">
                ...
                <span> <i class="fa-solid fa-book"></i> Green note Details</span>
                ...
                <div class="card-footer">
                    <button type="submit" class="note-btn">Sign & Send</button>
<button type="button" class="note-btn" onclick="window.location.href='{{ route('leaves.index') }}'">Back</button>
