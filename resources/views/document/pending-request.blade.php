                    ...
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                ...
                                <button type="button" class="btn btn-primary add-btn" onclick="window.location.href='{{ route('documents.index') }}'">Back</button>
...
<td>
    {{ $usernameFrwd ? $usernameFrwd->first_name . ' ' . $usernameFrwd->middle_name . ' ' . $usernameFrwd->last_name . '-' . $usernameFrwd->department_name . '-' . $usernameFrwd->designation_name : 'N/A' }}
                                    ...
                                    <td class="taluka">@if ($document->status == 'pending')
