...
@endphp
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
               ...
               <form class="leave-form" autocomplete="off" action="{{ route('checklist-new.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <select id="name" name="user_id" class="form-control @error('user_id') is-invalid @enderror">
        ...
        @error('user_id') <!-- Update to match the validation field name -->
            <div class="invalid-feedback text-red">{{ $message }}</div>
        @enderror
    </div>
        ...
        <div class="col-md-6">
            ...
            <select id="checklist_name" name="checklist_name" class="form-control @error('checklist_name') is-invalid @enderror" >
                <option value="">Select Checklist</option>
                @foreach($checklistMasters as $checklist)
                    <option value="{{ $checklist->checklist_name }}">{{ $checklist->checklist_name }}</option>
                @endforeach
            </select>
    ...
    <div class="col-md-12 mb-3">
        ...
        <div class="form-check">
            <input class="form-check-input @error('process_status') is-invalid @enderror" type="radio" name="process_status" id="status_yes" value="Yes" >
            <label class="form-check-label" for="status_yes">Yes</label>
        </div>
        <div class="form-check">
            <input class="form-check-input @error('process_status') is-invalid @enderror" type="radio" name="process_status" id="status_no" value="No" >
