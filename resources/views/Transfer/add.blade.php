...
<!--    var oldValues = {-->
<!--        organisation: "{{ old('transfer_org_id') }}",-->
<!--        department: "{{ old('transfer_depart_id') }}",-->
<!--        designation: "{{ old('transfer_design_id') }}",-->
<!--        state: "{{ old('transfer_state') }}",-->
<!--        district: "{{ old('transfer_district') }}",-->
<!--        taluka: "{{ old('transfer_taluka') }}"-->
<!--    };-->
...
<!--            $.get('{{ route('tehsils.get') }}', { state: $('#state_2').val(), district: oldValues.district }, function (response) {-->
...
<!--            $.get('{{ route('organisations.get') }}', { state: $('#state_2').val(), district: $('#district_2').val() }, function (response) {-->
...
<!--            $.get('{{ route('departments.get') }}', { state: $('#state_2').val(), district: $('#district_2').val(), organisation: $('#organisation_2').val() }, function (response) {-->
...
<!--            $.get('{{ route('designations.getByTaluka') }}', { taluka_id: taluka, organisation_id: organisation }, function (response) {-->
...
<!--            });-->
<!--        } else if (department) {-->
<!--            $.get('{{ route('designations.get') }}', { department_id: department }, function (response) {-->
<!--                setOldValue('#designation_2', oldValues.designation, response.map(designation => ({ value: designation.id, text: designation.designation_name })));-->
<!--            });-->
<!--        }-->
<!--    }-->
