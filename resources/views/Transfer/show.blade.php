...
<div class="row">
    <div class="col-lg-12">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" id="state" name="state" class="form-control readonly-input" value="{{ $transfer->state }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="district" class="form-label">District</label>
                        <input type="text" id="district" name="district" class="form-control readonly-input" value="{{ $transfer->district }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="organisation" class="form-label">Select Organization</label>
                        <input type="text" id="organisation" name="org_id" class="form-control readonly-input" value="{{ $transfer->org_name }}" readonly>
                    </div>
                </div><!-- end row -->
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="depart_id" id="department_name" class="form-control readonly-input" value="{{ $transfer->name }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="taluka-field" class="form-label">Taluka</label>
                        <input type="text" id="taluka-field" name="taluka" class="form-control readonly-input" value="{{ $transfer->taluka }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="designation" class="form-label">Select Designation</label>
                        <input type="text" name="design_id" id="designation" class="form-control readonly-input" value="{{ $transfer->designation_name }}" readonly>
                    </div>
                </div><!-- end row -->
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" id="name" name="user_id" class="form-control readonly-input" value="{{ $transfer->first_name }} {{ $transfer->last_name }}" readonly>
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="text" id="last_working_date" name="last_working_date" 
                            ...
                            value="{{ $transfer->last_working_date }}" readonly>
                    </div>
                </div><!-- end row -->
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" id="transfer_state" name="transfer_state" class="form-control readonly-input" value="{{  $transfer->transfer_state}}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="transfer_district" class="form-label">District</label>
                        <input type="text" id="transfer_district" name="transfer_district" class="form-control readonly-input" value="{{ $transfer->transfer_district }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="transfer_organisation" class="form-label">Select Organisation</label>
                        <input type="text" id="transfer_organisation" name="transfer_org_id" class="form-control readonly-input" value="{{ $transfer->org_name }}" readonly>
                    </div>
                </div><!-- end row -->
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="transfer_depart_id" id="transfer_department_name" class="form-control readonly-input" value="{{ $transfer->name }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="transfer_taluka" class="form-label">Taluka</label>
                        <input type="text" id="transfer_taluka" name="transfer_taluka" class="form-control readonly-input" value="{{ $transfer->transfer_taluka }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label for="transfer_designation" class="form-label">Select Designation</label>
                        <input type="text" name="transfer_design_id" id="transfer_designation" class="form-control readonly-input" value="{{ $transfer->designation_name}}" readonly>
                    </div>
                </div><!-- end row -->
     ...
     <form action="{{ route('transferstatus', $transfer->id) }}" id="transferForm" method="POST">
    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            @if($transfer->user_status != 'pending')
            @if((($transfer->Status =='pending' || ($transfer->Status == 'approved_clerk' && $transfer->frwd_hod_id == Auth::user()->id )) && Auth::user()->is_admin == 'staff' ))
          
            <!-- Approve Button -->
           
              <button type="button" id="send-button" class="btn btn-primary me-2" data-docuser="{{$transfer->id}}" data-bs-toggle="modal" data-bs-target="#ForwardModel">Send</button>

              
            <button type="button" id="approve-button" class="btn btn-success me-2" data-docuser ="{{$transfer->id}}" >Send & Sign</button>

            <!-- Reject Button -->
            <button type="button" id="reject-button" class="btn btn-danger">Reject</button>
            
             @elseif(($transfer->Status == 'pending' || $transfer->Status == 'approved_clerk') && Auth::user()->is_admin != 'staff')
            ...
            <button type="button"  class="btn btn-danger">Rejected</button>
              @endif
              @else
              <button type="button" id="verify-button" class="btn btn-primary me-2" data-docuser ="{{$transfer->id}}" >Verify User Digital Signature </button>
              @endif
        </div>
    </div>
            ...
            <div class="modal-body">
                <!--<form id="frwd_to_staff_Form"> -->
                    <div class="form-group">
                        ...
                        <input type="hidden" name="frwd_leave_id" value="{{ $transfer->id }}" id="frwd_leave_id">
...
<!--  <form id="transferForm" action="{{ route('transferstatus', $transfer->id) }}" method="POST">-->
<!--    @csrf-->
<!--    @method('PATCH')-->
        ...
        .then(data => {
            if (data.success) {
                ...
                verifyUserClerkModal.hide(); // Close the modal on success
                                                                window.location.href = "{{ route('transfer.pending') }}";
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Approve Button Click Event with SweetAlert Confirmation
    approveButton.addEventListener('click', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                statusField.value = 'approved'; // Set the status field to 'approved'
                const statusFieldType = document.getElementById('status-field-type');
                statusFieldType.value = 'other'; // Set the status field type to 'other'
                ...
                // If the user cancels, log a message or handle accordingly
