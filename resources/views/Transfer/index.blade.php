 ...
 <div class="checkmark-container">
    ...
    <div class="d-flex align-items-center">
        <div class="remove me-2"> 
                                            ...
                                            @if ($transfer->Status != 'rejected' && $transfer->Status != 'approved_clerk'&& $transfer->Status != 'approved' )
                    <button type="button" class="btn btn-sm btn-primary edit-item-btn" onclick="window.location.href='{{ route('transfer.edit' ,  $transfer->id) }}'">
                      ...
                      @endif
                        ...
                        @endif
                                                                                                                       ...
                                                                                                                       <button class="btn btn-sm btn-warning remove-item-btn" onclick="printAffidavit({{ $transfer->id }})">
    Print
</button>
