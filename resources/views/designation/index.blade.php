...
<div class="row">
    <div class="col-xxl-7">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                ...
                <a href="{{route('designations.showdata')}}"> <button class="btn btn-sm btn-primary mx-2 " data-id="">
    ...
    <td>{{ $designation->id }}</td>
                                ...
                                <td style="display:flex">
                                    ...
                                    <button class="btn btn-sm btn-primary mx-2 editDesignation" data-id="{{ $designation->id }}">
...
<div class="mb-3">
    ...
    @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="designation_name" class="form-control @error('designation_name') is-invalid @enderror" id="editDesignationName" placeholder="Enter designation name">
                        @error('designation_name')
                            <div class="invalid-feedback" style="color: red;">
                                {{ $message }}
                            </div>
