...
@if($user)
    <h4 class="fs-16 mb-1">
        {{ $greeting }}, {{ strtoupper($user->first_name) }} - {{ strtoupper($user->name) }} - {{ strtoupper($user->designation_name) }}
    </h4>
@endif
                </div>
                ...
                <div class="row text-center">
                    <div class="col">
                        ...
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $userPendingCount }}">{{ $userPendingCount }}</span>
                        </h4>
                    </div>
                    <div class="col">
                        <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $userApprovedCount }}">{{ $userApprovedCount }}</span>
                        </h4>
                    </div>
                    <div class="col">
                        <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $userRejectedCount }}">{{ $userRejectedCount }}</span>
                        </h4>
                    </div>
                </div>

                <div class="d-flex justify-content-between align-items-center mt-3">
                    <a href="{{ route('user-details-view') }}" class="text-decoration-underline">View all</a>
                    <div class="avatar-sm">
                ...
                <div class="mt-4">
                    <div class="row text-center">
                        <div class="col">
                                                <span class="badge bg-warning-subtle text-warning text-uppercase">Pending</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $documentPendingCount }}">{{ $documentPendingCount }}</span>
                            </h4>
                        </div>
                        <div class="col">
                                                <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $documentApprovedCount }}">{{ $documentApprovedCount }}</span>
                            </h4>
                        </div>
                        <div class="col">
                                                 <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $documentRejectedCount }}">{{ $documentRejectedCount }}</span>
                            </h4>
                        </div>
                    </div>

                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <a href="{{ route('documents.index') }}" class="text-decoration-underline">View all</a>
                        <div class="avatar-sm">
                ...
                <div class="mt-4">
                    <div class="row text-center">
                        <div class="col">
                                                <span class="badge bg-warning-subtle text-warning text-uppercase">Pending</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $pendingCount }}">{{ $pendingCount }}</span>
                            </h4>
                        </div>
                        <div class="col">
                                                <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $approvedCount }}">{{ $approvedCount }}</span>
                            </h4>
                        </div>
                        <div class="col">
                                                 <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $rejectCount }}">{{ $rejectCount }}</span>
                            </h4>
                        </div>
                    </div>

                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <a href="{{ route('leaves.index') }}" class="text-decoration-underline">View all</a>
                        <div class="avatar-sm">
                ...
                <div class="mt-4">
                    <div class="row text-center">
                        <div class="col">
                                                <span class="badge bg-warning-subtle text-warning text-uppercase">Pending</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $nominationPendingCount }}">{{ $nominationPendingCount }}</span>
                            </h4>
                        </div>
                        <div class="col">
                                                <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $nominationApprovedCount }}">{{ $nominationApprovedCount }}</span>
                            </h4>
                        </div>
                        <div class="col">
                                                 <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $nominationRejectedCount }}">{{ $nominationRejectedCount }}</span>
                            </h4>
                        </div>
                    </div>

                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <a href="{{ route('nomination-index') }}" class="text-decoration-underline">View all</a>
                        <div class="avatar-sm">
            ...
            <div class="mt-4">
                <div class="row text-center">
                    <div class="col">
                        <span class="badge bg-warning-subtle text-warning text-uppercase">Pending</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $salaryPendingCount }}">{{ $salaryPendingCount }}</span>
                        </h4>
                    </div>
                    <div class="col">
                        <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $salaryApprovedCount }}">{{ $salaryApprovedCount }}</span>
                        </h4>
                    </div>
                    <div class="col">
                        <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $salaryRejectedCount }}">{{ $salaryRejectedCount }}</span>
                        </h4>
                    </div>
                </div>

                <div class="d-flex justify-content-between align-items-center mt-3">
                    <a href="{{ route('salary.index') }}" class="text-decoration-underline">View all</a>
                    <div class="avatar-sm">
                        <span class="avatar-title bg-success rounded fs-3">
                ...
                <div class="mt-4">
                    <div class="row text-center">
                        <div class="col">
                            <span class="badge bg-warning-subtle text-warning text-uppercase">Pending</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $checklistPendingCount }}">{{ $checklistPendingCount }}</span>
                            </h4>
                        </div>
                        <div class="col">
                            <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $checklistApprovedCount }}">{{ $checklistApprovedCount }}</span>
                            </h4>
                        </div>
                        <div class="col">
                            <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $checklistRejectedCount }}">{{ $checklistRejectedCount }}</span>
                            </h4>
                        </div>
                    </div>

                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <a href="{{ route('checklist-new.index') }}" class="text-decoration-underline">View all</a>
                        <div class="avatar-sm">
                            <span class="avatar-title bg-success rounded fs-3">
            ...
            <div class="mt-4">
                <div class="row text-center">
                    <div class="col">
                        <span class="badge bg-warning-subtle text-warning text-uppercase">Pending</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $receiptPendingCount }}">{{ $receiptPendingCount }}</span>
                        </h4>
                    </div>
                    <div class="col">
                        <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $receiptApprovedCount }}">{{ $receiptApprovedCount }}</span>
                        </h4>
                    </div>
                    <div class="col">
                        <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $receiptRejectedCount }}">{{ $receiptRejectedCount }}</span>
                        </h4>
                    </div>
                </div>

                <div class="d-flex justify-content-between align-items-center mt-3">
                    <a href="{{ route('receipts.index') }}" class="text-decoration-underline">View all</a>
                    <div class="avatar-sm">
                        <span class="avatar-title bg-info rounded fs-3">
            ...
            <div class="mt-4">
                <div class="row text-center">
                    <div class="col">
                        <span class="badge bg-warning-subtle text-warning text-uppercase">Pending</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $transferPendingCount }}">{{ $transferPendingCount }}</span>
                        </h4>
                    </div>
                    <div class="col">
                        <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $transferApprovedCount }}">{{ $transferApprovedCount }}</span>
                        </h4>
                    </div>
                    <div class="col">
                        <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $transferRejectedCount }}">{{ $transferRejectedCount }}</span>
                        </h4>
                    </div>
                </div>

                <div class="d-flex justify-content-between align-items-center mt-3">
                    <a href="{{ route('transfer.index') }}" class="text-decoration-underline">View all</a>
                    <div class="avatar-sm">
                        <span class="avatar-title bg-info rounded fs-3">
            ...
            <div class="mt-4">
                <div class="row text-center">
                    <div class="col">
                        <span class="badge bg-warning-subtle text-warning text-uppercase">Pending</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $affidavitPendingCount }}">{{ $affidavitPendingCount }}</span>
                        </h4>
                    </div>
                    <div class="col">
                        <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $affidavitApprovedCount }}">{{ $affidavitApprovedCount }}</span>
                        </h4>
                    </div>
                    <div class="col">
                        <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $affidavitRejectedCount }}">{{ $affidavitRejectedCount }}</span>
                        </h4>
                    </div>
                </div>

                <div class="d-flex justify-content-between align-items-center mt-3">
                    <a href="{{ route('getaffidavit') }}" class="text-decoration-underline">View all</a>
                    <div class="avatar-sm">
                        <span class="avatar-title bg-info rounded fs-3">
            ...
            <div class="mt-4">
                <div class="row text-center">
                    <div class="col">
                        <span class="badge bg-warning-subtle text-warning text-uppercase">Pending</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $achievementPendingCount }}">{{ $achievementPendingCount }}</span>
                        </h4>
                    </div>
                    <div class="col">
                        <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $achievementApprovedCount }}">{{ $achievementApprovedCount }}</span>
                        </h4>
                    </div>
                    <div class="col">
                        <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                        <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                            <span class="counter-value" data-target="{{ $achievementRejectedCount }}">{{ $achievementRejectedCount }}</span>
                        </h4>
                    </div>
                </div>

                <div class="d-flex justify-content-between align-items-center mt-3">
                    <a href="{{ route('getahievement') }}" class="text-decoration-underline">View all</a>
                    <div class="avatar-sm">
                        <span class="avatar-title bg-primary rounded fs-3">
                ...
                <div class="mt-4">
                    <div class="row text-center">
                        <div class="col">
                            <span class="badge bg-warning-subtle text-warning text-uppercase">Pending</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $auditPendingCount }}">{{ $auditPendingCount }}</span>
                            </h4>
                        </div>
                        <div class="col">
                            <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $auditApprovedCount }}">{{ $auditApprovedCount }}</span>
                            </h4>
                        </div>
                        <div class="col">
                            <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                            <h4 class="fs-22 fw-semibold ff-secondary mt-1">
                                <span class="counter-value" data-target="{{ $auditRejectedCount }}">{{ $auditRejectedCount }}</span>
                            </h4>
                        </div>
                    </div>

                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <a href="{{ route('audits.index') }}" class="text-decoration-underline">View all</a>
                        <div class="avatar-sm">
                            <span class="avatar-title bg-primary rounded fs-3">
                            ...
                            <div class="row g-0 text-center">
                                <div class="col-6 col-sm-3">
                                    <div class="p-3 border border-dashed border-start-0">
                                        <h5 class="mb-1"><span class="counter-value" data-target="{{ $pendingCount }}">{{ $pendingCount }}</span></h5>
                                ...
                                <div class="col-6 col-sm-3">
                                    <div class="p-3 border border-dashed border-start-0">
                                        <h5 class="mb-1"><span class="counter-value" data-target="{{ $approvedCount }}">{{ $approvedCount }}</span></h5>
                                ...
                                <div class="col-6 col-sm-3">
                                    <div class="p-3 border border-dashed border-start-0">
                                        <h5 class="mb-1"><span class="counter-value" data-target="{{ $rejectCount }}">{{ $rejectCount }}</span></h5>
    ...
    <div class="card">
        ...
        <div class="card-header p-0 border-0 bg-light-subtle">
            <div class="row g-0 text-center">
                <div class="col-6 col-sm-3">
                    <div class="p-3 border border-dashed border-start-0">
                        <h5 class="mb-1"><span class="counter-value" data-target="{{ $salaryPendingCount }}">{{ $salaryPendingCount }}</span></h5>
                ...
                <div class="col-6 col-sm-3">
                    <div class="p-3 border border-dashed border-start-0">
                        <h5 class="mb-1"><span class="counter-value" data-target="{{ $salaryApprovedCount }}">{{ $salaryApprovedCount }}</span></h5>
                ...
                <div class="col-6 col-sm-3">
                    <div class="p-3 border border-dashed border-start-0">
                        <h5 class="mb-1"><span class="counter-value" data-target="{{ $salaryRejectedCount }}">{{ $salaryRejectedCount }}</span></h5>
...
<script>
    var options = {
        ...
        yaxis: {
            ...
            max: Math.max(
                Math.max(...@json($pendingCountPerMonth)),
                Math.max(...@json($approvedCountPerMonth)),
                Math.max(...@json($rejectCountPerMonth))
...
<script>
    var options = {
        ...
        series: [
            {
                name: 'Pending',
                type: 'bar', // Display as a bar chart
                data: @json($salaryPendingCountPerMonth),
                color: '#1E90FF' // Blue color for pending
            },
            {
                name: 'Approved',
                type: 'line', // Display as a line chart
                data: @json($salaryApprovedCountPerMonth),
                color: '#32CD32' // Green color for approved
            },
            {
                name: 'Rejected',
                type: 'line', // Display as a line chart
                data: @json($salaryRejectedCountPerMonth),
                color: '#FF6347' // Red color for rejected
            }
        ],
        stroke: {
        ...
        yaxis: {
            min: 0, // Minimum value for y-axis
            max: Math.max(
                Math.max(...@json($salaryPendingCountPerMonth)),
                Math.max(...@json($salaryApprovedCountPerMonth)),
                Math.max(...@json($salaryRejectedCountPerMonth))
            ) + 10, // Add padding to the max value for better display
            title: {
