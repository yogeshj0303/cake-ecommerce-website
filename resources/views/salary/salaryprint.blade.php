...
<tr class="table-row">
    ...
    <td class="table-cell">{{ ucfirst($user->caste ?? '- -') }}</td>
</tr>
...
<tr class="table-row">
    ...
    <td class="table-cell">{{ $user->last_salary ?? '- -' }}</td>
...
<td class="table-cell">{{ str_replace('₹', '', $user->slap_amount) ?? '' }}</td>
</tr>
<tr class="table-row">
    <td class="table-cell">{{ $rowNumber++ }}</td>
    <td class="table-cell" style="font-weight: bold;">Grade Amount</td>
<td class="table-cell">{{ str_replace('₹', ' ', $user->grade_amount) ?? '' }}</td>

</tr>
<tr class="table-row">
    <td class="table-cell">{{ $rowNumber++ }}</td>
    <td class="table-cell" style="font-weight: bold;">Direct Added Amount</td>
<td class="table-cell">{{ $user->direct_added_amount ? str_replace('₹', '', $user->direct_added_amount) : '- -' }}</td>

</tr>
<tr class="table-row">
    <td class="table-cell">{{ $rowNumber++ }}</td>
    <td class="table-cell" style="font-weight: bold;">Level</td>
    <td class="table-cell">{{ $user->label ?? '- -' }}</td>
</tr>
<tr class="table-row">
    <td class="table-cell">{{ $rowNumber++ }}</td>
    <td class="table-cell" style="font-weight: bold;">Merge Amount</td>
                <td class="table-cell">{{ $user->merge_amount ? str_replace('₹', '', $user->merge_amount) : '- -' }}</td>
...
<tr class="table-row">
    ...
    <td class="table-cell" style="font-weight: bold;">Direct Total Salary</td>
                                    <td class="table-cell">{{ $user->direct_total_salary ? str_replace('₹', '', $user->direct_total_salary) : '- -' }}</td>
...
<tr class="table-row">
    ...
    <td class="table-cell" style="font-weight: bold;">Salary Amount</td>
            <td class="table-cell">{{ str_replace('₹', '', $user->salary_amount) ?? '- -' }}</td>
...
<tr class="table-row">
    ...
    <td class="table-cell">{{ $user->reference_document ?? '- -' }}</td>
</tr>
...
<tr class="table-row">
    ...
    <td class="table-cell" colspan="2" style="padding: 10px 0 10px 10px;">
        ...
        <div style="font-size: 14px; color: #333; line-height: 1.6;">
            {!! strip_tags($user->salarynote, '<b><i><u><strong><em><br>') !!}
        </div>
    </td>
</tr>
<tr class="table-row">
    ...
    <td class="table-cell" colspan="2" style="padding: 10px 0 10px 10px;">
        <div style="font-weight: bold; font-size: 14px; margin-bottom: 5px;">
         Salary Letter        </div>
        <div style="font-size: 14px; color: #333; line-height: 1.6;">
            {!! strip_tags($user->salaryletter, '<b><i><u><strong><em><br>') !!}
        </div>
    </td>
</tr>
