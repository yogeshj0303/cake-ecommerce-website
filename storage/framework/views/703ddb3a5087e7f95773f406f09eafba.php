                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush border-dashed mb-0">
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/btc.svg')); ?>" class="avatar-xs shadow rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/eth.svg')); ?>" class="avatar-xs shadow rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/aave.svg')); ?>" class="avatar-xs shadow rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/doge.svg')); ?>" class="avatar-xs shadow rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/bnb.svg')); ?>" class="avatar-xs shadow rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/ltc.svg')); ?>" class="avatar-xs shadow rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-middle">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/small/img-1.jpg')); ?>" class="rounded img-fluid shadow" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" class="rounded img-fluid shadow" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" class="rounded img-fluid shadow" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" class="rounded img-fluid shadow" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/dashboard-crypto.blade.php ENDPATH**/ ?>