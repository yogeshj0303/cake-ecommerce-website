            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                        <i class="mdi mdi-view-carousel-outline"></i> <span><?php echo app('translator')->get('translation.layouts'); ?></span> <span class="badge badge-pill bg-danger"><?php echo app('translator')->get('translation.hot'); ?></span>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="icons-remix" class="nav-link"><span><?php echo app('translator')->get('translation.remix'); ?></span><span class="badge badge-pill bg-info">v3.5</span></a></li>
                            <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\material\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>