                    ...
                    <div class="table" id="customerList">
                        <div class="row g-4 mb-3">
                            <div class="col-sm-auto">
                                <div>
                                    <a href="<?php echo e(route('leaves.index')); ?>"><button type="button" class="btn btn-primary ">Back </button></a>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive mt-3 mb-1">
                            <table class="table table-bordered" id="designationsTable">
                              ...
                              <tr id="userRow<?php echo e($leave->id); ?>">
                                            ...
                                            <td class="available_leave"><?php echo e($leave->available_leave); ?></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/user-leaves/pending.blade.php ENDPATH**/ ?>