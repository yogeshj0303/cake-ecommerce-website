            ...
            <div class="card-body">
                <div class="listjs-table" id="customerList">
                    ...
                    <?php if((isset($permissions)) && ( ($permissions['other_receipt_create'] == 2))): ?>
                      ...
                      <a href="<?php echo e(route('receipts.create')); ?>"><button type="button" class="btn btn-success ">Add </button></a>
                      <?php endif; ?>
                    <a href="<?php echo e(route('receipts.pending')); ?>"><button type="button" class="btn btn-warning ">Request </button></a>
                <a href="<?php echo e(route('receipts.history')); ?>"><button type="button" class="btn btn-primary ">History </button></a>
 ...
 -->                                  
  ...
  <?php if((isset($permissions)) && (
   ...
   ($permissions['other_receipt_create'] == 2)
                            ...
                            <tr id="userRow<?php echo e($receipt->id); ?>">
                                <td><?php echo e($receipt->id); ?></td>

                                <td><?php echo e($receipt->first_name); ?>  <?php echo e($receipt->middle_name); ?> <?php echo e($receipt->last_name); ?></td>
...
<td>
    <?php echo e($usernameFrwd ? $usernameFrwd->first_name . ' ' . $usernameFrwd->middle_name . ' ' . $usernameFrwd->last_name . '-' . $usernameFrwd->department_name . '-' . $usernameFrwd->designation_name : 'N/A'); ?>
                                     ...
                                     <td><?php echo e($receipt->reject_description); ?></td>
                                    ...
                                    <!-- Image placed over the text -->
                                                <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                                </div><?php elseif($receipt->status == 'rejected' && $receipt->frwd_hod_id == null ): ?>
...
<?php if($receipt->status != 'rejected' && $receipt->status != 'approved_clerk' && $receipt->status != 'approved' ): ?>
 <?php if((isset($permissions)) && (($permissions['other_receipt_edit'] == 2) )): ?>
                                    <a href="<?php echo e(route('receipts.edit' ,$receipt->id )); ?>" class="btn btn-primary btn-sm">Edit</a>
                                    <?php endif; ?>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                     <?php if((isset($permissions)) && (($permissions['other_receipt_delete'] == 2) )): ?>
<button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-id="<?php echo e($receipt->id); ?>" data-bs-target="#deleteRecordModal">
    Remove
</button>
<?php endif; ?>

                        
                                                                                                                       <button class="btn btn-sm btn-warning remove-item-btn" onclick="printAffidavit(<?php echo e($receipt->id); ?>)">
    Print
</button>
    ...
    function printAffidavit(userId) {
        var printWindow = window.open('/receiptprint/' + userId, '_blank');
    ...
    $('#deleteForm').submit(function(event) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    alert('Receipt delete successfully')
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/receipt/index.blade.php ENDPATH**/ ?>