...
<td>
 ...
 <div class="checkmark-container">
                               ...
                               <td><?php if($item->hod_otp_status == 1 ): ?>
                               ...
                               <div class="checkmark-container">
                                ...
                                <?php else: ?> <?php if($item->status == 'rejected'): ?>  <div class="checkmark-container">
                                    <!-- Image placed over the text -->
                                                 <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                                </div> <?php else: ?>
  <div class="checkmark-container">
    ...
    ($permissions['nomination_view'] == 2) || ($permissions['nomination_edit'] == 2) || ($permissions['nomination_delete'] == 2)
                                         ...
                                         <div class="remove">
                                               <?php if((isset($permissions)) && (($permissions['nomination_edit'] == 2))): ?>
                                                  <?php if($item->status != 'approved'&& $item->status != 'approved_clerk' && $item->status != 'approved_clerk' && $item->status != 'rejected' ): ?>
...
<?php endif; ?>
                                                                    ...
                                                                    <button class="btn btn-sm btn-warning remove-item-btn" onclick="printAffidavit(<?php echo e($item->id); ?>)">
    Print
</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/nomination/index.blade.php ENDPATH**/ ?>