                ...
                <div class="listjs-table" id="customerList">
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            ...
                            <button type="button" class="btn btn-success add-btn" onclick="window.location.href='<?php echo e(route('salary.create')); ?>'">
                                Add Salary
                            </button>
                            <?php endif; ?>
...
<?php endif; ?>
    ...
    ($permissions['salary_delete'] == 2))): ?>
                                  <?php if($salary->Status != 'rejected' && $salary->Status != 'approved'): ?> 
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/salary/index.blade.php ENDPATH**/ ?>