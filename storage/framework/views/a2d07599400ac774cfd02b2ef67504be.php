...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <input type="text" id="birth_date" name="birth_date" class="form-control <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('birth_date')); ?>" readonly/>
            <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-6">
            ...
            <input type="text" id="join-date-field" name="join_date" class="form-control <?php $__errorArgs = ['join_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('join_date')); ?>" readonly/>
...
unset($__errorArgs, $__bag); ?>">
    ...
    <?php $__currentLoopData = $Nominationtype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Nominationtypes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($Nominationtypes->nomination_type); ?>" 
            <?php echo e(old('nomination_type') == $Nominationtypes->nomination_type ? 'selected' : ''); ?>>
            <?php echo e($Nominationtypes->nomination_type); ?>
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <input 
                    ...
                    name="nominee_name[]" 
                    class="form-control <?php $__errorArgs = ['nominee_name.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    value="<?php echo e(old('nominee_name.0')); ?>" />
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <input 
                    ...
                    class="form-control <?php $__errorArgs = ['nominee_dob.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                    value="<?php echo e(old('nominee_dob.0')); ?>" />
...
unset($__errorArgs, $__bag); ?>
            ...
            <input type="hidden" id="formatted_nominee_date" name="formatted_nominee_date[]" value="<?php echo e(old('formatted_nominee_date.0')); ?>" />
            ...
            <div class="col-md-4">
                ...
                <input 
                    ...
                    name="nominee_age[]"  
                    class="form-control <?php $__errorArgs = ['nominee_age.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    value="<?php echo e(old('nominee_age.0')); ?>" />
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <input 
                    ...
                    name="atypical_event[]" 
                    class="form-control <?php $__errorArgs = ['atypical_event.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    value="<?php echo e(old('atypical_event.0')); ?>" />
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <input 
                    ...
                    class="form-control <?php $__errorArgs = ['relationship_nominee.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    value="<?php echo e(old('relationship_nominee.0')); ?>" />
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <select 
                    ...
                    name="nominee_type[]" 
                    class="form-control <?php $__errorArgs = ['nominee_type.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> nominee-type">
                    ...
                    <option value="Main" <?php echo e(old('nominee_type.0') == 'Main' ? 'selected' : ''); ?>>Main Nominee</option>
                    <option value="Sub" <?php echo e(old('nominee_type.0') == 'Sub' ? 'selected' : ''); ?>>Sub Nominee</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <input 
                    ...
                    name="nominee_amount[]" 
                    class="form-control <?php $__errorArgs = ['nominee_amount.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> nominee-amount" 
                    placeholder="Enter Amount or Portion" 
                    value="<?php echo e(old('nominee_amount.0')); ?>" />
...
const oldNomineeData = <?php echo json_encode(old('nominee_name', []), 512) ?>;
const oldNomineeDob = <?php echo json_encode(old('nominee_dob', []), 512) ?>;
const oldNomineeAge = <?php echo json_encode(old('nominee_age', []), 512) ?>;
const oldAtypicalEvent = <?php echo json_encode(old('atypical_event', []), 512) ?>;
const oldNomineeType = <?php echo json_encode(old('nominee_type', []), 512) ?>;
const oldNomineeAmount = <?php echo json_encode(old('nominee_amount', []), 512) ?>;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/nomination/create.blade.php ENDPATH**/ ?>