                                    ...
                                    <td>
                                     ...
                                     <?php endif; ?>
                                       <td>
                                         <div class="form-check form-switch form-switch-warning mb-2 mb-md-0">
                                            ...
                                            <?php echo e($user->other_receipt_edit == 2 ? 'checked' : ''); ?> >
                                            <label class="form-check-label" for="cardtableCheck01">Edit</label>
                                        </div>
                                     ...
                                     <td>
                                         <div class="form-check form-switch form-switch-danger mb-2 mb-md-0">
                                            ...
                                            <?php echo e($user->other_receipt_delete == 2 ? 'checked' : ''); ?> >
                                            <label class="form-check-label" for="cardtableCheck01">Delete</label>
                                        </div>
                               ...
                               <?php if((isset($permissions)) && (($permissions['receipt_master_view'] == 2) || ($permissions['receipt_master_create'] == 2) || ($permissions['receipt_master_edit'] == 2)|| ($permissions['receipt_master_delete'] == 2) )): ?>
                                    ...
                                    <?php if((isset($permissions)) && (($permissions['tehsils_create'] == 2) )): ?>
                                     ...
                                     <td>
                                         <div class="form-check form-switch form-switch-warning mb-2 mb-md-0">
                                            ...
                                            <?php echo e($user->tehsils_edit == 2 ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="cardtableCheck01">Edit</label>
                                        </div>
                                ...
                                <?php if((isset($permissions)) && (($permissions['document_master_view'] == 2) || ($permissions['document_master_create'] == 2) || ($permissions['document_master_edit'] == 2)|| ($permissions['document_master_delete'] == 2) )): ?>
                                  ...
                                  <tr>
                                    ...
                                    <?php endif; ?>
                                    <?php if((isset($permissions)) && (($permissions['document_master_edit'] == 2) )): ?>
                                     <td>
                                         <div class="form-check form-switch form-switch-warning mb-2 mb-md-0">
                                            <input class="form-check-input" type="checkbox" name="document_master_edit" value="2" id="cardtableCheck01" 
                                            <?php echo e($user->document_master_edit == 2 ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="cardtableCheck01">Edit</label>
                                        </div>
...
<?php if(!$isAdmin): ?>
    ...
    <input type="hidden" name="designation" value="<?php echo e(old('designation', $user->designation_name)); ?>">
    <input type="hidden" name="department_name" value="<?php echo e(old('department_name', $user->name)); ?>">
    <input type="hidden" name="organisation" value="<?php echo e(old('organisation', $user->org_name)); ?>">
<?php endif; ?>
...
$(document).ready(function() {
    ...
    var initialOrganisation = '<?php echo e($user->org_name); ?>';
        ...
        var initialRoles = '<?php echo e($user->role_name); ?>'; 
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/organization-login/assign-permission/edit.blade.php ENDPATH**/ ?>