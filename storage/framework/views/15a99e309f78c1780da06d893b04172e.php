                ...
                <div class="card-body">
                    <div class="listjs-table" id="customerList">
                        <div class="row g-4 mb-3">
                            ...
                            <button type="button" class="btn btn-success add-btn" onclick="window.location.href='<?php echo e(route('newsalaryadd')); ?>'">
                                Add Salary
                            </button>
                            <?php endif; ?>
                            <button type="button" class="btn btn-warning " onclick="window.location.href='<?php echo e(route('salary.pending')); ?>'">
                                Request
                            </button>
                            <a href="<?php echo e(route('salary-history')); ?>" > <button class="btn  btn-primary ">
                                            History
                                        </button></a>
...
<td>                                            <?php if($salary->status == 'pending'): ?>
                ...
                <td>
                    <?php if($salary->clerk_otp_status == 1): ?>
...
<div class="checkmark-container">
                ...
                <td>
                    <?php if($salary->hod_otp_status == 1): ?>
                        <div class="checkmark-container">
                                                <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                        </div>
                    <?php elseif($salary->status == 'rejected'): ?>
                ...
                <?php if(isset($permissions) && ($permissions['salary_view'] == 2 || $permissions['salary_edit'] == 2 || $permissions['salary_delete'] == 2)): ?>
                    <td>
                        <?php if(isset($permissions) && ($permissions['salary_edit'] == 2 || $permissions['salary_delete'] == 2)): ?>
                            <?php if($salary->status != 'rejected' && $salary->status != 'approved_clerk' && $salary->status != 'approved'): ?>
                
                                            <button type="button" class="btn btn-sm btn-primary edit-item-btn" onclick="window.location.href='<?php echo e(route('editsalary', $salary->id)); ?>'">
                                Edit
                            </button>
                            <?php endif; ?>
                        <?php endif; ?>
...
<button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-id="<?php echo e($salary->id); ?>" data-bs-target="#deleteRecordModal">
    Remove
</button>
                        ...
                        <?php endif; ?>
                                                                                            ...
                                                                                            <button class="btn btn-sm btn-warning remove-item-btn" onclick="printAffidavit(<?php echo e($salary->id); ?>)">
    Print
</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/salary/newsalary_index.blade.php ENDPATH**/ ?>