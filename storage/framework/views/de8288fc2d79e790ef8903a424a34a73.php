...
<?php $__env->startSection('content'); ?>
    ...
    <tbody class=" list form-check-all">
                                    ...
                                    <?php $__currentLoopData = $nominationsdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
...
<!--</td>-->
 ...
 <td><?php echo e($item->nominee_name); ?></td>
                                    <td><?php echo e($item->nominee_dob); ?></td>
                                    <td><?php echo e($item->nominee_age); ?></td>
                                    <td><?php echo e($item->atypical_event); ?></td>
                                    <td><?php echo e($item->relationship_nominee); ?></td>
                                    <td><?php echo e($item->nominee_type); ?></td>
                                    <td><?php echo e($item->nominee_amount); ?></td>
<!--                                    <td>-->
                                        
                                        
<!--                                         <div class="remove">-->
<!--    <button class="btn  remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal" data-id="<?php echo e($item->id); ?>">-->
<!--        <i class="fas fa-trash-alt"></i>-->
<!--    </button>-->

<!--    <button class="btn  remove-item-btn" data-bs-id="<?php echo e($item->id); ?>">-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/nomination/show.blade.php ENDPATH**/ ?>