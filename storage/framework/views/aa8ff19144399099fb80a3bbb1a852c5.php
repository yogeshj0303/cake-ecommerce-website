...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Organization Login</h4>
                </div><!-- end card header -->
                        ...
                        <div class="row g-4 mb-3">
                            <div class="col-sm-auto">
                                <div>
                                   ...
                                   <button type="button" class="btn btn-success add-btn" onclick="window.location.href='<?php echo e(route('organization.create')); ?>'">
                                    Add
                                </button>
                                <?php endif; ?>
                                </div>
    ...
    <thead class="table-light">
        <tr>
            ...
            <th class="sort" data-sort="total_leaves">Email</th>
            <th class="sort" data-sort="total_leaves">Username</th>
            <?php if((isset($permissions)) && ( 
    ($permissions['organization_edit'] == 2) || 
    ($permissions['organization_delete'] == 2)
)): ?>
    ...
    <tbody class="  form-check-all">
        <?php if((isset($permissions)) && (
    ($permissions['organization_view'] == 2) || 
    ...
    ($permissions['organization_delete'] == 2)
        ...
        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <tr id="userRow<?php echo e($user->id); ?>">
                           <td class="first_name"><?php echo e($loop->iteration); ?></td>
            ...
            <td class="total_leaves"><?php echo e($user->email); ?></td>
            <td class="total_leaves"><?php echo e($user->username); ?></td>
            <?php if((isset($permissions)) && ( 
    ($permissions['organization_edit'] == 2) || 
    ($permissions['organization_delete'] == 2)
)): ?>
            <td>
                ...
                <div class="d-flex gap-2">
                   <?php if((isset($permissions)) && (($permissions['organization_edit'] == 2))): ?>
                    ...
                    <button type="button" class="btn btn-sm btn-primary edit-item-btn" onclick="window.location.href='<?php echo e(route('organization.edit' ,  $user->id)); ?>'">
                          Edit
                      </button>
...
<?php endif; ?>
 ...
 <div class="show">
                    ...
                    <button type="button" class="btn btn-sm btn-success edit-item-btn" onclick="window.location.href='<?php echo e(route('organization.show' ,  $user->id)); ?>'">
                          view
                      </button>
   ...
   <script>
    ...
    $(document).ready(function() {
        $('.remove-item-btn').click(function() {
            var id = $(this).data('id');
        var action = '/organization-login/' + id; 
    ...
    document.querySelectorAll('.edit-item-btn').forEach(function (button) {
        button.addEventListener('click', function () {
            ...
            form.action = '/organization-login/' + id; // Make sure this matches your route
        });
    });
});
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/organization-login/index.blade.php ENDPATH**/ ?>