            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" id="name" name="user_id" class="form-control readonly-input" value="<?php echo e($transfer->first_name); ?> <?php echo e($transfer->last_name); ?>" readonly>
                    </div>
                    <div class="col-md-3">
        ...
        .then(data => {
            if (data.success) {
                ...
                verifyUserClerkModal.hide(); // Close the modal on success
                                                                window.location.href = "<?php echo e(route('transfer.pending')); ?>";
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/Transfer/show.blade.php ENDPATH**/ ?>