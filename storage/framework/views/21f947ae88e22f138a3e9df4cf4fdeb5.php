...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Volume</h4>
                </div><!-- end card header -->
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center">
            ...
            <button type="button" class="btn btn-info me-2">Create Volume</button>
            <div class="dropdown">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/file/created/Complete/volume.blade.php ENDPATH**/ ?>