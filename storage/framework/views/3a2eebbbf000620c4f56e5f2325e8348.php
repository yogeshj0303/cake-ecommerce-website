    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="leave-form" autocomplete="off" action="<?php echo e(route('users.update', $user->id)); ?>" method="post" enctype="multipart/form-data" >
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter First Name" value="<?php echo e(old('first_name', $user->first_name)); ?>" />
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter Middle Name" value="<?php echo e(old('middle_name', $user->middle_name)); ?>" />
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter Last Name" value="<?php echo e(old('last_name', $user->last_name)); ?>" />
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter Email" value="<?php echo e(old('email', $user->email)); ?>" />
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="password-confirm-field" name="password_confirmation" class="form-control <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter Contact Number" value="<?php echo e(old('number', $user->number)); ?>" />
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter Address" value="<?php echo e(old('address', $user->address)); ?>" />
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter Total Yearly Leaves" value="<?php echo e(old('leaves', $user->leaves)); ?>" />
...
<input type="file" name="old_book" id="file1" value="<?php echo e(old('old_book', $user->old_book)); ?>" class="form-control" accept=".pdf,.doc,.docx,.jpeg,.png,.jpg,.gif" onchange="uploadFile()" />
                    <small class="form-text text-muted">Choose a file to upload.</small>
                <?php if($user->old_book): ?>
        <div class="mt-0">
            <a href="<?php echo e(asset('images/' . $user->old_book)); ?>" target="_blank" class="">
                View Old Book
            </a>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/user-profile/edit.blade.php ENDPATH**/ ?>