...
<div class="table-responsive mt-3 mb-1" style="width: 100%;">
    ...
    ($permissions['userdetail_delete'] == 2)
        ...
        <!--<td><?php echo e($sno++); ?></td>-->
                ...
                <td class="first_name"><?php echo e($user->first_name); ?> <?php echo e($user->middle_name); ?> <?php echo e($user->last_name); ?></td>
                <td class="caste"><?php echo e($user->caste ?? 'No data available'); ?></td>
                                <td class="address_B"><?php echo e($user->address ?? 'No data available'); ?></td>
...
<td class="birth_date"><?php echo e(\Carbon\Carbon::parse($user->birth_date)->format('Y-m-d') ?? 'No data available'); ?></td>
...
<td>
    <?php echo e($usernameFrwd ? $usernameFrwd->first_name . ' ' . $usernameFrwd->middle_name . ' ' . $usernameFrwd->last_name . '-' . $usernameFrwd->department_name . '-' . $usernameFrwd->designation_name : 'N/A'); ?>
                               ...
                               <td><?php if($user->hod_otp_status == 1 ): ?> <div class="checkmark-container">
                                    ...
                                    <!-- Image placed over the text -->
                                                <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                                </div>  <?php else: ?> <?php if($user->status == 'rejected'): ?> 
    ...
    ($permissions['userdetail_delete'] == 2)
                ...
                <td>
                    <div class="d-flex gap-2">
                        <?php if($user->status != 'approved' && $user->status != 'approved_clerk' && $user->status != 'rejected'): ?>
                        <div class="edit">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/user-profile/view_details_table.blade.php ENDPATH**/ ?>