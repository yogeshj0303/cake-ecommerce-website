...
<head>
    ...
    <title>USER TRANSFER REPORT</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <h1 class="page-title">USER TRANSFER REPORT</h1>
...
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Last Working Date </td>
    <td class="table-cell"><?php echo e($user->last_working_date ?? '- -'); ?></td>
</tr>

<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Transfer Location </td>
    <td class="table-cell"><?php echo e($user->transfer_state ?? '- -'); ?> - <?php echo e($user->transfer_district ?? '- -'); ?> 
        <?php echo e($user->transfer_taluka ? '- ' . $user->transfer_taluka : ''); ?>
...
</html><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/Transfer/transferprint.blade.php ENDPATH**/ ?>