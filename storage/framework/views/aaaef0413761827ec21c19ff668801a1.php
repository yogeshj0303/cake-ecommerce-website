                    ...
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                ...
                                <button type="button" class="btn btn-success add-btn" onclick="window.location.href='<?php echo e(route('documents.create')); ?>'">Add</button>
                            <?php endif; ?>
                               <button type="button" class="btn btn-warning add-btn" onclick="window.location.href='<?php echo e(route('pending.document')); ?>'">Request</button>
                              <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo e(route('documents-profile-history')); ?>'">History</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/document/index.blade.php ENDPATH**/ ?>