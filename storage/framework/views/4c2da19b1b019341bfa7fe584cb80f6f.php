...
<tr class="table-row">
    ...
    <td class="table-cell"><?php echo e($user->checklist_name ?? '- -'); ?></td>
</tr>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Process Status</td>
    <td class="table-cell"><?php echo e($user->process_status ?? '- -'); ?></td>
</tr>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Receipt Process Status</td>
    <td class="table-cell"><?php echo e($user->receipt_process_status ?? '- -'); ?></td>
</tr>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Page Number</td>
    <td class="table-cell"><?php echo e($user->page_no ?? '- -'); ?></td>
</tr>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Receipt Number</td>
    <td class="table-cell"><?php echo e($user->receipt_no ?? '- -'); ?></td>
</tr>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Receipt Status</td>
    <td class="table-cell"><?php echo e($user->receipt_status ?? '- -'); ?></td>
</tr>
...
</html><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/checklist-master/newchecklistprint.blade.php ENDPATH**/ ?>