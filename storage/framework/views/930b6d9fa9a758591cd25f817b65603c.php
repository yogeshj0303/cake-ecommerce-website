                    ...
                    <div class="timeline-item left">
                        ...
                        <div class="content">
                            ...
                            <div class="row border border-dashed rounded gx-2 p-2">
                                <div class="col-3">
                                    <img src="<?php echo e(URL::asset('build/images/small/img-2.jpg')); ?>" alt="" class="img-fluid rounded shadow">
                                </div>
                                <!--end col-->
                                <div class="col-3">
                                    <img src="<?php echo e(URL::asset('build/images/small/img-3.jpg')); ?>" alt="" class="img-fluid rounded shadow">
                                </div>
                                <!--end col-->
                                <div class="col-3">
                                    <img src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="" class="img-fluid rounded shadow">
                                </div>
                                <!--end col-->
                                <div class="col-3">
                                    <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" class="img-fluid rounded shadow">
                                </div>
                                <!--end col-->
                            </div>
                            <!--end row-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/pages-timeline.blade.php ENDPATH**/ ?>