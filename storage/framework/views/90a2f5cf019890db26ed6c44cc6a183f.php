...
<div class="row">
    ...
    Request
                               ...
                               <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo e(route('showauditHistory')); ?>'">History</button>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $audits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $audit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr id="userRow<?php echo e($audit->id); ?>">
                                 ...
                                 <td><?php echo e($audit->first_name); ?>  <?php echo e($audit->middle_name); ?> <?php echo e($audit->last_name); ?></td>
...
<td>
    <?php echo e($usernameFrwd ? $usernameFrwd->first_name . ' ' . $usernameFrwd->middle_name . ' ' . $usernameFrwd->last_name . '-' . $usernameFrwd->department_name . '-' . $usernameFrwd->designation_name : 'N/A'); ?>
          ...
          <td class="status">
                                    ...
                                    <!-- Image placed over the text -->
                                                <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                                </div><?php else: ?> <?php if($audit->status == 'rejected'): ?>  
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="d-flex gap-2">
             <?php if($audit->status != 'rejected'  && $audit->status != 'approved_clerk'&& $audit->status != 'approved'): ?>
...
<button class="btn btn-sm btn-success" onclick="window.location.href='<?php echo e(route('audits.show', $audit->id)); ?>'">View</button>
         <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal" data-id="<?php echo e($audit->id); ?>">Remove</button>
                                                                                                                                         <button class="btn btn-sm btn-warning remove-item-btn" onclick="printAffidavit(<?php echo e($audit->id); ?>)">
    Print
</button>
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/audit/index.blade.php ENDPATH**/ ?>