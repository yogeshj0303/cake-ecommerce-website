                    ...
                    <div class="row g-4 mb-3">
                            <div class="col-sm-auto">
                                <div>
                                   ...
                                   <button type="button" class="btn btn-success add-btn" onclick="window.location.href='<?php echo e(route('transfer.create')); ?>'">
    Add Transfer
</button>
 <button type="button" class="btn btn-success add-btn" onclick="window.location.href='<?php echo e(route('joining.create')); ?>'">
    Add Joining
</button>
<?php endif; ?>
         <button type="button" class="btn btn-warning" onclick="window.location.href='<?php echo e(route('transfer.pending')); ?>'">
    Request
</button>
                 <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo e(route('transfer.history')); ?>'">
    History
</button>
                            </div>
                        </div>
...
<?php if((isset($permissions)) && (
    ...
    ($permissions['trans_join_delete'] == 2)
                                ...
                                <tr id="transferRow<?php echo e($transfer->id); ?>">
                                    ...
                                    <td><?php echo e($transfer->first_name); ?>  <?php echo e($transfer->middle_name); ?>  <?php echo e($transfer->last_name); ?> </td>
 ...
 <div class="checkmark-container">
                                    ...
                                    <!-- Image placed over the text -->
                                                <span class="badge bg-warning-subtle text-warning text-uppercase">Pending</span>
                                                              ...
                                                              <?php endif; ?> 
                                <?php endif; ?></td>
                               <td><?php if($transfer->hod_otp_status == 1 ): ?> <div class="checkmark-container">
                                  
                                
                                    <!-- Image placed over the text -->
                                                <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                                </div>  <?php else: ?> <?php if($transfer->Status == 'rejected'): ?>
                                ...
                                <?php endif; ?>
                                                 ...
                                                 <td>
                                                     ...
                                                     <?php echo e($transfer->reject_description); ?>
    ...
    <div class="d-flex align-items-center">
        <div class="remove me-2"> 
                                            ...
                                            <?php if($transfer->Status != 'rejected' && $transfer->Status != 'approved_clerk'&& $transfer->Status != 'approved' ): ?>
                    <button type="button" class="btn btn-sm btn-primary edit-item-btn" onclick="window.location.href='<?php echo e(route('transfer.edit' ,  $transfer->id)); ?>'">
                          Edit
                      </button>
                      <?php endif; ?>
                      <?php endif; ?>
                           <?php if((isset($permissions)) && ( ($permissions['trans_join_delete'] == 2))): ?>
                            <button class="btn btn-sm btn-danger remove-item-btn" data-id="<?php echo e($transfer->id); ?>" data-bs-toggle="modal" data-bs-target="#deleteRecordModal">Remove</button>
                            <?php endif; ?>
                        ...
                        <?php endif; ?>
                                                                                                                       ...
                                                                                                                       <button class="btn btn-sm btn-warning remove-item-btn" onclick="printAffidavit(<?php echo e($transfer->id); ?>)">
    Print
</button>
    ...
    function printAffidavit(userId) {
        var printWindow = window.open('/transferprint/' + userId, '_blank');
    ...
    $('#deleteForm').submit(function(event) {
        ...
        $.ajax({
            ...
            success: function(response) {
                                                        alert('Transfer delete successfully')
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/Transfer/index.blade.php ENDPATH**/ ?>