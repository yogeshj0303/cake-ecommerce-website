...
<tr class="table-row">
    ...
    <td class="table-cell"><?php echo e($user->affidavitname ?? '- -'); ?></td>
</tr>
...
<tr class="table-row">
    ...
    <td class="table-cell" colspan="2" style="padding: 10px 0 10px 10px;">
        ...
        <div style="font-size: 14px; color: #333; line-height: 1.6;">
            <?php echo strip_tags($user->affidavit_memo, '<b><i><u><strong><em><br>'); ?>
...
</html><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/affidavit/Affidavitprint.blade.php ENDPATH**/ ?>