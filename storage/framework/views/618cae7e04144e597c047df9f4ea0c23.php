    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="leave-form" autocomplete="off" action="<?php echo e(route('roles.update', $user->id)); ?>" method="post" enctype="multipart/form-data">
<?php echo csrf_field(); ?>     
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/organization-login/add-role/edit.blade.php ENDPATH**/ ?>