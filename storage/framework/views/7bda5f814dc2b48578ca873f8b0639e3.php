    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            ...
            <!-- Approve Button -->
              ...
              <button type="button" id="send-button" class="btn btn-primary me-2" data-docuser="<?php echo e($Affidavit->id); ?>" data-bs-toggle="modal" data-bs-target="#ForwardModel" <?php if($Affidavit->witness_first_status === 'pending' || $Affidavit->witness_second_status === 'pending'): ?> disabled <?php endif; ?>>Send</button>

              
            <button type="button" id="approve-button" class="btn btn-success me-2" data-docuser ="<?php echo e($Affidavit->id); ?>"  <?php if($Affidavit->witness_first_status === 'pending' || $Affidavit->witness_second_status === 'pending'): ?> disabled <?php endif; ?>>Send & Sign</button>

            <!-- Reject Button -->
            <button type="button" id="reject-button" class="btn btn-danger" <?php if($Affidavit->witness_first_status === 'pending' || $Affidavit->witness_second_status === 'pending'): ?> disabled <?php endif; ?>>Reject</button>
            ...
            <button type="button"  class="btn btn-danger">Rejected</button>
              ...
              <!--<button type="button" id="sendWitnessOtp-button" class="btn btn-primary me-2" data-docuser="<?php echo e($Affidavit->id); ?>" data-bs-toggle="modal" data-bs-target="#sendWitnessOtp">Verify Witness Digital Signature</button>-->
              <!-- <?php endif; ?>-->
              
              
               <?php if($Affidavit->witness_first_status == 'pending' && ($Affidavit->status === 'pending') && $Affidavit->witness_second_status === 'pending'): ?>
              <button type="button" id="sendWitnessOtp-button" class="btn btn-primary me-2" data-docuser="<?php echo e($Affidavit->id); ?>"  data-bs-toggle="modal" data-bs-target="#sendWitnessOtp">Verify First Witness Digital Signature</button>
               <!--<button type="button" class="btn btn-primary me-2" disabled>Verify Second Witness Digital Signature</button>-->
              <?php elseif($Affidavit->witness_first_status === 'approved' && ($Affidavit->status ==='pending') && $Affidavit->witness_second_status === 'pending' ): ?>
          <button type="button" class="btn btn-success me-2" disabled>Witness First (verified)</button>
              <!--<button type="button" id="sendWitnessOtp-button" class="btn btn-primary me-2" data-docuser="<?php echo e($Affidavit->id); ?>" data-bs-toggle="modal" data-bs-target="#sendWitnessOtp">Verify Second Witness Digital Signature</button>-->
               <?php elseif($Affidavit->witness_first_status === 'approved' &&  $Affidavit->witness_second_status === 'approved'  ): ?>
          <button type="button" class="btn btn-success me-2" disabled>Witness First (verified)</button>
...
<!--            <div class="modal-footer">-->
<!--                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>-->
<!--                <button type="button" id="verify-button" class="btn btn-danger" data-docuser="<?php echo e($Affidavit->id); ?>">Send</button>-->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
<!--</div>-->
  ...
  <div class="modal fade" id="sendWitnessOtp" tabindex="-1" aria-labelledby="sendWitnessOtpLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" id="verify-button" class="btn btn-danger"  data-docuser="<?php echo e($Affidavit->id); ?>" 
                 <?php if($Affidavit->witness_first_status === 'pending'  ): ?> data-witness_type="first" <?php else: ?> data-witness_type="second" <?php endif; ?> >Send</button>
            </div>
        </div>
    </div>
</div>     
...
//                     window.location.href = "<?php echo e(route('affidavits-pending')); ?>";
//             } else {
...
// <?php endif; ?>
 ...
 <?php if($Affidavit->witness_first_status == 'pending' || $Affidavit->witness_second_status == 'pending'): ?>
<script>
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $('#ForwardModel').modal('hide'); // Close the modal
                                                window.location.href = "<?php echo e(route('getaffidavit')); ?>";
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/affidavit/affidavitshow.blade.php ENDPATH**/ ?>