...
<?php endif; ?>
   ...
   <div classs="row" style="display:flex; 
        ...
        <div class="card" style=" width: 50%;
            ...
            position: relative;
            border-right: 1px solid #ccc;">
            <form  action="<?php echo e(route('sfs-electronics.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/file/electronic/sfs.blade.php ENDPATH**/ ?>