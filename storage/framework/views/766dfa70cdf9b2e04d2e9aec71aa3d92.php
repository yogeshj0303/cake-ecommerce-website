...
<div class="row">
                ...
                <div class="listjs-table" id="documentList">
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                              <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo e(route('getahievement')); ?>'">Back</button>
    ...
    <thead class="table-light">
        <tr>
            ...
            <th class="" data-sort="status">Forwarded to</th>
...
<td>
  ...
  <div class="checkmark-container">
                               ...
                               <td><?php if($document->hod_otp_status == 1 ): ?> <div class="checkmark-container">
                                    ...
                                    <!-- Image placed over the text -->
                                                <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                                </div>  <?php else: ?> <?php if($document->status == 'rejected'): ?> 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="readMoreModalLabel<?php echo e($document->id); ?>"> Achievement Memo </h5>
            ...
            <div class="modal-body">
                ...
                <?php echo $document->achivement_memo; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/achivement/pending.blade.php ENDPATH**/ ?>