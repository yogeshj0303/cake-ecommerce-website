                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted2" role="button"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('build/images/brands/slack.png')); ?>" alt="" class="avatar-xs rounded-circle shadow" />
                            </div>
                            <div class="flex-grow-1 ms-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\material\resources\views/apps-crm-deals.blade.php ENDPATH**/ ?>