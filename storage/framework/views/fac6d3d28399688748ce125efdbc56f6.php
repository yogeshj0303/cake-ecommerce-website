    ...
    ($permissions['checklist_delete'] == 2)
            ...
            <?php $__currentLoopData = $checklists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $checklist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="checklistRow<?php echo e($loop->iteration); ?>">
                    ...
                    <td class="reject_description"><?php echo e($checklist->reject_description); ?></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/checklist-master/pending-request.blade.php ENDPATH**/ ?>