...
<tr class="table-row">
    ...
    <td class="table-cell"><?php echo e($user->position ?? '- -'); ?></td>
</tr>

<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Birth Date</td>
    <td class="table-cell"><?php echo e(ucfirst($user->birth_date ?? '- -')); ?></td>
</tr>

<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Joining Date</td>
    <td class="table-cell"><?php echo e($user->join_date ?? '- -'); ?></td>
</tr>
...
<?php if($user->nominationstatus == 'rejected'): ?>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
...
<?php $__currentLoopData = $nominee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <thead>
        <tr>
            <th colspan="2" style="text-align: left; background-color: #f4f4f4; border: 1px solid black;">
                <?php echo e($detail->nominee_type); ?> Nominee
            </th>
        </tr>
    </thead>
    <tbody>
        <tr>
            ...
            <td class="table-cell" style="border: 1px solid black; width: 50%;"><?php echo e($detail->nominee_name ?? '- -'); ?></td>
        </tr>
        <tr>
            <td class="table-cell" style="font-weight: bold; border: 1px solid black;">Date of Birth</td>
            <td class="table-cell" style="border: 1px solid black;"><?php echo e($detail->nominee_dob ?? '- -'); ?></td>
        </tr>
        <tr>
            <td class="table-cell" style="font-weight: bold; border: 1px solid black;">Age</td>
            <td class="table-cell" style="border: 1px solid black;"><?php echo e($detail->nominee_age ?? '- -'); ?></td>
        </tr>
        <tr>
            <td class="table-cell" style="font-weight: bold; border: 1px solid black;">Atypical Event</td>
            <td class="table-cell" style="border: 1px solid black;"><?php echo e($detail->atypical_event ?? '- -'); ?></td>
        </tr>
        <tr>
            <td class="table-cell" style="font-weight: bold; border: 1px solid black;">Relationship</td>
            <td class="table-cell" style="border: 1px solid black;"><?php echo e($detail->relationship_nominee ?? '- -'); ?></td>
        </tr>
    </tbody>
</table>
...
<div class="signature-section" style="margin-top:70px">
        ...
        <div class="signature">
            <div class="signature-image">
                <img src="<?php echo e(public_path('checkmark.png')); ?>" alt="User Signature" class="signature-img">
                <div class="signature-overlay">
                    <p><?php echo e($user->witness_first_name); ?></p>
                    <p><?php echo e($user->witness_first_create); ?></p>
                </div>
            </div>
 ...
 <div class="signature">
            <div class="signature-image">
                <img src="<?php echo e(public_path('checkmark.png')); ?>" alt="User Signature" class="signature-img">
                <div class="signature-overlay">
                    <p><?php echo e($user->witness_second_name); ?></p>
                    <p><?php echo e($user->witness_second_create); ?></p>
                </div>
            </div>
                        <h6 style=" margin-top:5px;
...
</html><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/nomination/nominationprint.blade.php ENDPATH**/ ?>