...
<head>
    ...
    <title>USER ACHIEVEMENT REPORT</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <h1 class="page-title">USER ACHIEVEMENT REPORT</h1>
...
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Achievement Name</td>
    <td class="table-cell"><?php echo e($user->achivementname ?? '- -'); ?></td>
</tr>
...
<?php if(
    $user->achivementstatus == 'rejected'
): ?>
...
<tr class="table-row">
    ...
    <td class="table-cell" colspan="2" style="padding: 10px 0 10px 10px;">
        ...
        <div style="font-size: 14px; color: #333; line-height: 1.6;">
            <?php echo strip_tags($user->achivement_memo, '<b><i><u><strong><em><br>'); ?>
...
</html><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/achivement/achivementprint.blade.php ENDPATH**/ ?>