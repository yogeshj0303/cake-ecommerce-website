                    ...
                    <div class="row g-4 mb-3">
                        <div class="col-sm-auto">
                            <div>
                                ...
                                <button type="button" class="btn btn-success add-btn" onclick="window.location.href='<?php echo e(route('affidavits-add')); ?>'">Add</button>
                             <?php endif; ?>
                              
                 <button type="button" class="btn  btn-warning " onclick="window.location.href='<?php echo e(route('affidavits-pending')); ?>'">
                          Request
                         </button>
                               <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo e(route('getaffidavit.history')); ?>'">History</button>
    ...
    ($permissions['affidavit_view'] == 2) || ($permissions['affidavit_edit'] == 2) || ($permissions['affidavit_delete'] == 2))): ?>
        ...
        <tr id="documentRow<?php echo e($document->id); ?>">
            <td><?php echo e($document->id); ?></td>
                        <td><?php echo e($document->first_name); ?> <?php echo e($document->middle_name); ?> <?php echo e($document->last_name); ?></td>
...
<td>
    <?php echo e($usernameFrwd ? $usernameFrwd->first_name . ' ' . $usernameFrwd->middle_name . ' ' . $usernameFrwd->last_name . '-' . $usernameFrwd->department_name . '-' . $usernameFrwd->designation_name : 'N/A'); ?>
                                    ...
                                    <td><?php if($document->witness_first_status === 'approved'): ?>  
                             ...
                             <?php else: ?>
                                ...
                                <?php endif; ?>
                                   ...
                                   <td><?php if($document->witness_second_status === 'approved'): ?>  
                                ...
                                <?php endif; ?> </td>
                                    ...
                                    <!-- Image placed over the text -->
                                                <span class="badge bg-success-subtle text-success text-uppercase">Approved</span>
                                <?php else: ?> <?php if($document->status == 'rejected'): ?>  
                                                 <span class="badge bg-danger-subtle text-danger text-uppercase">Rejected</span>
                                 <?php else: ?> 
                                                <span class="badge bg-warning-subtle text-warning text-uppercase">Pending</span>
                                
                                <?php endif; ?> <?php endif; ?></td>
                               <td><?php if($document->hod_otp_status == 1 ): ?> 
    ...
    <div class="d-flex align-items-center">
        <div class="remove me-2"> <!-- Added margin-end for spacing -->
            ...
            <?php if($document->status != 'rejected' && $document->status != 'approved_clerk' && $document->status != 'approved' ): ?>
                <button class="btn edit-item-btn btn-sm btn-primary" onclick="window.location.href='<?php echo e(route('editaffidavit', $document->id)); ?>'">
                    Edit
                </button>
                <?php endif; ?>
            <?php endif; ?>
            <?php if((isset($permissions)) && (($permissions['affidavit_delete'] == 2))): ?>
                <button class="btn remove-item-btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteRecordModal" data-id="<?php echo e($document->id); ?>">
                    Remove
                </button>
            <?php endif; ?>
            ...
            <?php endif; ?>
                                                                                                                       ...
                                                                                                                       <button class="btn btn-sm btn-warning remove-item-btn" onclick="printAffidavit(<?php echo e($document->id); ?>)">
    Print
</button>
        </div>
    ...
    function printAffidavit(userId) {
        var printWindow = window.open('/affidavitprint/' + userId, '_blank');
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/affidavit/affidavit_index.blade.php ENDPATH**/ ?>