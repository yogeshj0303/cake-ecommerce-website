    ...
    ($permissions['leave_delete'] == 2)
                              ...
                              <tr id="userRow<?php echo e($leave->id); ?>">
                                          ...
                                          <td><?php echo e($leave->id); ?></td>
                                            ...
                                            <td class="customer_name"><?php echo e($leave->name); ?> <?php echo e($leave->middle_name); ?> <?php echo e($leave->last_name); ?></td>
                                            ...
                                            <td class="available_leave"><?php echo e($leave->reduce_available_leave); ?></td>
                                                                                         <td class="leave_category"><?php echo e($leave->leave_category); ?></td>
                                                                                                                                                                                  <td class="leave_category"><?php echo e($leave->description); ?></td>
...
?>
  ...
  <?php echo e($staff_name->first_name); ?> <?php echo e($staff_name->middle_name); ?> <?php echo e($staff_name->last_name); ?> - 
    <?php echo e($staff_name->department_name); ?>- 
    <?php echo e($staff_name->designation_name); ?> 
<?php else: ?>
   Staff
<?php endif; ?> <?php endif; ?> </td>
    ...
    ->first();
                                            ...
                                            ?>
                                             ...
                                             <?php if(isset($rejector->first_name)): ?>
    <?php echo e($rejector->first_name); ?> <?php echo e($rejector->middle_name); ?> <?php echo e($rejector->last_name); ?> - 
    <?php echo e($rejector->department_name); ?>- 
    <?php echo e($rejector->designation_name); ?> 
...
<div class="edit">
     <?php if($leave->status != 'approved' && $leave->status != 'approved_clerk' && $leave->status != 'rejected'): ?>
...
<?php endif; ?>
                                                                    ...
                                                                    <button class="btn btn-sm btn-warning remove-item-btn" onclick="printAffidavit(<?php echo e($leave->id); ?>)">
    Print
</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/user-leaves/index.blade.php ENDPATH**/ ?>