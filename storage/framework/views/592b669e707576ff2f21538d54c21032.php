...
?>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
<form class="leave-form" method="POST" action="<?php echo e(route('affidavits-store')); ?>" id="addaffidavitForm" autocomplete="off" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                ...
                <option value="<?php echo e($state['state']); ?>" 
                        <?php echo e(old('state', $user->state) === $state['state'] ? 'selected' : ''); ?>>
    ...
    <div class="col-md-6">
        ...
        <select name="affidavit_name" id="affidavitName" class="form-select mb-3">
            ...
            <?php $__currentLoopData = $AffidavitType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $AffidavitTypes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($AffidavitTypes->id); ?>"><?php echo e($AffidavitTypes->name); ?></option>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/affidavit/create.blade.php ENDPATH**/ ?>