...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Draft</h4>
                </div><!-- end card header -->
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <button type="button" class="btn btn-primary"  onclick="window.location.href='<?php echo e(route('draft.create')); ?>'">Forward</button>
            <button type="button" class="btn btn-secondary">View</button>
            <button type="button" class="btn btn-info">Create Volume</button>
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/file/created/Draft/index.blade.php ENDPATH**/ ?>