...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="leave-form"id="affidavit" method="POST" action="<?php echo e(route('updateaffidavit', $Affidavit->id)); ?>" autocomplete="off" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<div class="col-md-6">
    ...
    <select name="affidavit_name" id="affidavit_name" class="form-select mb-3">
        ...
        <?php $__currentLoopData = $AffidavitType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $AffidavitTypes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($AffidavitTypes->id); ?>" <?php echo e($Affidavit->affidavit_name == $AffidavitTypes->id ? 'selected' : ''); ?>><?php echo e($AffidavitTypes->name); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
    <?php $__errorArgs = ['affidavit_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group col-md-12">
        ...
        <div id="memo-editor" contenteditable="true" style="border: 1px solid #ccc; height: 200px; overflow-y: auto; padding: 10px;">
            <?php echo old('affidavit_memo', $Affidavit->affidavit_memo); ?>

        </div>
        <textarea id="memo" name="affidavit_memo" style="display:none;"><?php echo old('affidavit_memo', $Affidavit->affidavit_memo); ?></textarea>
    </div>
</div>
...
unset($__errorArgs, $__bag); ?>" />
        ...
        <?php if($Affidavit->refrence_docs): ?>
            <div class="mt-3">
                <a href="<?php echo e(asset('images/'.$Affidavit->refrence_docs)); ?>" target="_blank">View PDF</a>
            </div>
        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                 ...
                 <!--           <input type="file" id="witness_signature" name="witness_signature" class="form-control <?php $__errorArgs = ['witness_signature'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" />-->
                 ...
                 <!--               <img id="hod-signature-preview" src="<?php echo e(asset('images/'.$Affidavit->witness_signature)); ?>" alt="HOD Signature Preview" style="max-width: 200px; margin-top: 10px;" />-->
                 <!--           <?php endif; ?>-->
                 <!--           <?php $__errorArgs = ['witness_signature'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>-->
...
unset($__errorArgs, $__bag); ?>" />-->
                    ...
                    <!--            <img id="hod-signature-preview" src="<?php echo e(asset('images/'.$Affidavit->hod_signature)); ?>" alt="HOD Signature Preview" style="max-width: 200px; margin-top: 10px;" />-->
                    <!--        <?php endif; ?>-->
...
unset($__errorArgs, $__bag); ?>" />-->
                    ...
                    <!--            <img id="clerk-signature-preview" src="<?php echo e(asset('images/'.$Affidavit->clerk_signature)); ?>" alt="Clerk Signature Preview" style="max-width: 200px; margin-top: 10px;" />-->
                    <!--        <?php endif; ?>-->
...
unset($__errorArgs, $__bag); ?>-->
                    ...
                    <div style="display: flex; justify-content: flex-end; gap: 10px;">
                        ...
                        <div class="hstack gap-2">
                            <button type="button" class="btn btn-primary" onclick="window.location.href='<?php echo e(route('getaffidavit')); ?>'">Back</button>
                        </div>
                    </div>
                </form>
            </div><!-- end card body -->
...
$(document).ready(function() {
    ...
    <?php if($Affidavit->memo): ?>
        quill.root.innerHTML = `<?php echo $Affidavit->memo; ?>`;
    <?php endif; ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/affidavit/affidavitedit.blade.php ENDPATH**/ ?>