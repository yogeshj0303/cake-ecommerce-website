    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="col-sm-auto">
                                <div>
                                   <button type="button" class="btn btn-success add-btn" onclick="window.location.href='<?php echo e(route('audits.index')); ?>'">
    Back
</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/audit/pending-request.blade.php ENDPATH**/ ?>