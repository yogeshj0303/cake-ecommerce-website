...
<tr class="table-row">
    ...
    <td class="table-cell"><?php echo e($user->apply_start_date ?? '- -'); ?></td>
</tr>

<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Leave applied ending date</td>
    <td class="table-cell"><?php echo e($user->apply_end_date ?? '- -'); ?></td>
</tr>
...
<?php if($user->leavestatus == 'approved' && isset($user->hod_verify_staff)): ?>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Leave approved by</td>
    <td class="table-cell"><?php echo e($staff_name->first_name); ?> <?php echo e($staff_name->middle_name); ?> <?php echo e($staff_name->last_name); ?> - 
    <?php echo e($staff_name->department_name); ?>- 
    <?php echo e($staff_name->designation_name); ?> </td>
</tr>
<?php endif; ?>
...
<tr class="table-row">
    ...
    <td class="table-cell">
            <?php echo e($rejector->first_name); ?> <?php echo e($rejector->middle_name); ?> <?php echo e($rejector->last_name); ?>
...
<tr class="table-row">
    ...
    <td class="table-cell" colspan="2" style="padding: 10px 0 10px 10px;">
        ...
        <div style="font-size: 14px; color: #333; line-height: 1.6;">
            <?php echo strip_tags($user->leavenote, '<b><i><u><strong><em><br>'); ?>
...
</html><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/user-leaves/leaveprint.blade.php ENDPATH**/ ?>