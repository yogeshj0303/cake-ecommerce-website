...
<div class="row">
    <div class="col-xxl-7">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                ...
                <a href="<?php echo e(route('affidavits-type-history')); ?>"> <button class="btn btn-sm btn-primary "><i class="fa fa-eye"></i> History
                                        </button></a>
            </div>
            <div class="card-body">
    ...
    ($permissions['affidavit_type_delete'] == 2)
                                ...
                                <tr id="affidavitRow<?php echo e($affidavit->id); ?>">
    <td><?php echo e($affidavit->id); ?></td>
                                    <td class="Name"><?php echo e($affidavit->name); ?></td>
                                      <td>
                                 <!-- Eye Button -->
                <button class="btn btn-info btn-sm view-description" 
        data-description="<?php echo e($affidavit->memo); ?>" 
                        data-bs-toggle="modal" 
                        data-bs-target="#descriptionModal">
                    <i class="fas fa-eye"></i>view
                </button>
                </td>
                                    <!--<td class="memo"><?php echo $affidavit->memo; ?></td>-->
                                    <?php if((isset($permissions)) && (
    ...
    ($permissions['affidavit_type_delete'] == 2)
                            ...
                            <button class="btn btn-sm btn-primary mx-2 editaffidavittBtn" data-id="<?php echo e($affidavit->id); ?>" data-name="<?php echo e($affidavit->name); ?>" data-memo="<?php echo e($affidavit->memo); ?>">

                                            <i class="fa fa-edit"></i> Edit
                                        </button>
                                        <?php endif; ?>
                                         <?php if((isset($permissions)) && (($permissions['affidavit_type_delete'] == 2) )): ?>
                                        <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal" data-id="<?php echo e($affidavit->id); ?>">
                                            Remove
                                        </button>
                                        <?php endif; ?>
                                    </td>
  ...
  <?php if((isset($permissions)) && (($permissions['affidavit_type_create'] == 2) )): ?>
    <div class="col-xxl-5">
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form action="<?php echo e(route('affidavits.store')); ?>" id="addaffidavitForm" method="POST" class="row g-3" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>" id="name" placeholder="Enter affidavit name">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/affidavit/index.blade.php ENDPATH**/ ?>