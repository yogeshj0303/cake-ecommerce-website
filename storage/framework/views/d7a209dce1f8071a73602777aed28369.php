                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/eur.svg')); ?>" alt=""
                                        class="avatar-xxs me-2 rounded-circle shadow">
                                    EUR
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/gbp.svg')); ?>" alt=""
                                        class="avatar-xxs me-2 rounded-circle shadow">
                                    GBP
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/jpy.svg')); ?>" alt=""
                                        class="avatar-xxs me-2 rounded-circle shadow">
                                    JPY
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/xpm.svg')); ?>" alt=""
                                        class="avatar-xxs me-2 rounded-circle shadow">
                                    XPM
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/ppt.svg')); ?>" alt=""
                                        class="avatar-xxs me-2 rounded-circle shadow">
                                    PPT
                                </div>
                            </td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/apps-crypto-transactions.blade.php ENDPATH**/ ?>