    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
              ...
              <form class="leave-form" autocomplete="off" action="<?php echo e(route('organization.store')); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter First Name" value="<?php echo e(old('first_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-4">
            ...
            <input type="text" id="middle_name" name="middle_name" class="form-control <?php $__errorArgs = ['middle_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter Last Name" value="<?php echo e(old('last_name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <input type="tel" id="number" name="number" class="form-control <?php $__errorArgs = ['number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter Contact Number" value="<?php echo e(old('number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter Username" value="<?php echo e(old('username')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter Address" value="<?php echo e(old('address')); ?>" required>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/organization-login/create.blade.php ENDPATH**/ ?>