...
<body>
    ...
    <div class="container">
        <h1 class="page-title">USER AUDIT REPORT</h1>
...
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Audit Name</td>
    <td class="table-cell"><?php echo e($user->audit_name ?? '- -'); ?></td>
</tr>
    ...
    <tr class="table-row">
        <td class="table-cell"><?php echo e($rowNumber++); ?></td>
        <td class="table-cell" style="font-weight: bold;">Audit Remark</td>
        <td class="table-cell"><?php echo e($user->audit_remark ?? '- -'); ?></td>
    </tr>
    <tr class="table-row">
        <td class="table-cell"><?php echo e($rowNumber++); ?></td>
        <td class="table-cell" style="font-weight: bold;">Auditor Name</td>
        <td class="table-cell"><?php echo e($user->auditor_name ?? '- -'); ?></td>
    </tr>
    <tr class="table-row">
        <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    ...
    <tr class="table-row">
        <td class="table-cell"><?php echo e($rowNumber++); ?></td>
        <td class="table-cell" style="font-weight: bold;">Organization Name</td>
        <td class="table-cell"><?php echo e($user->organisation_name ?? '- -'); ?></td>
    </tr>

  <tr class="table-row">
        <td class="table-cell"><?php echo e($rowNumber++); ?></td>
        <td class="table-cell" style="font-weight: bold;">Auditor Verification Description</td>
        <td class="table-cell"><?php echo e($user->auditor_veri_des ?? '- -'); ?></td>
    </tr>
...
</html><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/audit/auditprint.blade.php ENDPATH**/ ?>