    ...
    ($permissions['checklist_delete'] == 2)
            ...
            <?php $__currentLoopData = $checklists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $checklist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="checklistRow<?php echo e($checklist->id); ?>">
                    ...
                    <td class="status">                                            <?php if($checklist->Status == 'pending'): ?>
                    ...
                    <td>
                        <?php echo e($checklist->reject_description); ?>         <!-- Eye Button -->
                </td>
    ...
    ($permissions['checklist_delete'] == 2)
                    ...
                    <td>
                        <div class="d-flex gap-2">
                           ...
                           <?php endif; ?>
                                                                                               <button class="btn btn-sm btn-warning remove-item-btn" onclick="printAffidavit(<?php echo e($checklist->id); ?>)">
    Print
</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/checklist-master/newchecklist.blade.php ENDPATH**/ ?>