        ...
        <div class="col-lg-12" style="margin-left:200px">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">File Movement Report</h4>
                          ...
                          <div class="col-lg-12" style="margin:10px">
                                <div class="mt-4 mt-lg-0">
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="inlineRadio1">FileMovement Report</label>
                                    </div>
                                    <div class="form-check form-check-inline">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/report/file-movement.blade.php ENDPATH**/ ?>