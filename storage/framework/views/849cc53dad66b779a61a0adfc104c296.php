...
<head>
    ...
    <title>USER SALARY REPORT</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        <h1 class="page-title">USER SALARY REPORT</h1>
...
<tr class="table-row">
    ...
    <td class="table-cell"><?php echo e(ucfirst($user->caste ?? '- -')); ?></td>
</tr>


<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Last Approved salary</td>
    <td class="table-cell"><?php echo e($user->last_salary ?? '- -'); ?></td>
...
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">SLAP Amount</td>
<td class="table-cell"><?php echo e(str_replace('₹', '', $user->slap_amount) ?? ''); ?></td>
</tr>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Grade Amount</td>
<td class="table-cell"><?php echo e(str_replace('₹', ' ', $user->grade_amount) ?? ''); ?></td>

</tr>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Direct Added Amount</td>
<td class="table-cell"><?php echo e($user->direct_added_amount ? str_replace('₹', '', $user->direct_added_amount) : '- -'); ?></td>

</tr>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Level</td>
    <td class="table-cell"><?php echo e($user->label ?? '- -'); ?></td>
</tr>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Merge Amount</td>
                <td class="table-cell"><?php echo e($user->merge_amount ? str_replace('₹', '', $user->merge_amount) : '- -'); ?></td>


</tr>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Direct Total Salary</td>
                                    <td class="table-cell"><?php echo e($user->direct_total_salary ? str_replace('₹', '', $user->direct_total_salary) : '- -'); ?></td>
...
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Salary Amount</td>
            <td class="table-cell"><?php echo e(str_replace('₹', '', $user->salary_amount) ?? '- -'); ?></td>

</tr>

<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
    <td class="table-cell" style="font-weight: bold;">Reference Document</td>
    <td class="table-cell"><?php echo e($user->reference_document ?? '- -'); ?></td>
</tr>
...
<?php if($user->salarystatus == 'rejected'): ?>
<tr class="table-row">
    <td class="table-cell"><?php echo e($rowNumber++); ?></td>
...
<?php endif; ?>
   ...
   <?php if($user->salarystatus == 'approved'): ?>
...
<tr class="table-row">
    ...
    <td class="table-cell" colspan="2" style="padding: 10px 0 10px 10px;">
        ...
        <div style="font-size: 14px; color: #333; line-height: 1.6;">
            <?php echo strip_tags($user->salarynote, '<b><i><u><strong><em><br>'); ?>
...
<tr class="table-row">
    ...
    <td class="table-cell" colspan="2" style="padding: 10px 0 10px 10px;">
        <div style="font-weight: bold; font-size: 14px; margin-bottom: 5px;">
         Salary Letter        </div>
        <div style="font-size: 14px; color: #333; line-height: 1.6;">
            <?php echo strip_tags($user->salaryletter, '<b><i><u><strong><em><br>'); ?>
...
<div class="signature-section">
    ...
    <?php if(isset($clerk)): ?>
        ...
        <h6 style="margin-bottom:0px; margin-top:6px" >Clerk Digital Signature</h6>
   ...
   <?php if(isset($hod) && $user->clerk_verify_staff): ?> 
        <div class="signature">
            <div class="signature-image">
             ...
             <h6 style="margin-bottom:0px; margin-top:6px" >HOD Digital Signature</h6>
...
</html><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/salary/salaryprint.blade.php ENDPATH**/ ?>