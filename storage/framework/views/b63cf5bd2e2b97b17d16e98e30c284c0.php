...
<?php $__env->startSection('content'); ?>
   ...
   <div classs="row" style="display:flex;
        ...
        <div class="card" style=" width: 50%;
            ...
            height:300px;
            ">
            <form  action="<?php echo e(route('updategreennote' , $leaveuser->id )); ?>"id="greenNoteForm" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<button type="button" class="note-btn" onclick="window.location.href='<?php echo e(route('leaves.index')); ?>'">Back</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/user-leaves/green_note.blade.php ENDPATH**/ ?>