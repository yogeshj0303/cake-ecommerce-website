...
<div class="row">
    <div class="col-lg-12">
                ...
                <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="state" class="form-control" value="<?php echo e($user->state); ?>" readonly>
                            </div>
                            <div class="col-md-4">
                                <label for="district" class="form-label">District</label>
                                <input type="text" name="district" class="form-control" value="<?php echo e($user->district); ?>" readonly>
                            </div>
                            <div class="col-md-4">
                                <label for="organisation" class="form-label">Organization</label>
                                <input type="text" name="org_name" class="form-control" value="<?php echo e($user->org_name); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="department" class="form-control" value="<?php echo e($user->name); ?>" readonly>
                            </div>
                            
                                                        <div class="col-md-4">
                                <label for="taluka" class="form-label">Taluka</label>
                                <input type="text" name="taluka" class="form-control" value="<?php echo e($user->taluka); ?>" readonly>
                            </div>
                            <div class="col-md-4">
                                <label for="designation" class="form-label">Designation</label>
                                <input type="text" name="designation" class="form-control" value="<?php echo e($user->designation_name); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="profile_name" class="form-control" value="<?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="caste" class="form-control" value="<?php echo e($user->caste); ?>" readonly>
                            </div>
                            <div class="col-md-4">
                                <label for="address_a" class="form-label">Address A</label>
                                <input type="text" name="address_a" class="form-control" value="<?php echo e($user->address); ?>" readonly>
                            </div>
                            <div class="col-md-4">
                                <label for="address_b" class="form-label">Address B</label>
                                <input type="text" name="address_b" class="form-control" value="<?php echo e($user->address_B); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="father_name" class="form-control" value="<?php echo e($user->father_name); ?>" readonly>
                            </div>
                             <div class="col-md-4">
                                <label for="father_address" class="form-label">Father's Address</label>
                                <input type="text" name="father_address" class="form-control" value="<?php echo e($user->father_address); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="" name="birth_date" class="form-control" value="<?php echo e($user->birth_date); ?>" readonly>
                            </div>
                            <div class="col-md-4">
                                <label for="height" class="form-label">Height</label>
                                <input type="text" name="height" class="form-control" value="<?php echo e($user->height); ?>" readonly>
                            </div>
                            <div class="col-md-4">
                                <label for="birth_mark" class="form-label">Birth Mark</label>
                                <input type="text" name="birth_mark" class="form-control" value="<?php echo e($user->birth_mark); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="qualification" class="form-control" value="<?php echo e($user->qualification); ?>" readonly>
                            </div>
                            <div class="col-md-6">
                                <label for="another_qualification" class="form-label">Additional Qualification</label>
                                <input type="text" name="another_qualification" class="form-control" value="<?php echo e($user->another_qualification); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                                ...
                                <input type="text" name="address_b" class="form-control" value="<?php echo e($user->qualification); ?>" readonly>
                            </div>                            <div class="col-md-4">
                                <label for="address_b" class="form-label">After Joining Education Qualification</label>
                                <input type="text" name="address_b" class="form-control" value="<?php echo e($user->another_qualification); ?>" readonly>
                            </div>

                            <div class="col-md-4">
                                <label for="certificate_no" class="form-label">Certificate Number</label>
                                <input type="text" name="certificate_no" class="form-control" value="<?php echo e($user->certificate_no); ?>" readonly>
                            </div>
                        </div>
     ...
     <form action="<?php echo e(route('user-details-status', $user->id)); ?>" id="detailuserForm" method="POST">
    ...
    <div class="row">
        <div class="col-md-12 mb-3">
            ...
            <!-- Approve Button -->
              ...
              <button type="button" id="send-button" class="btn btn-primary me-2" data-docuser="<?php echo e($user->id); ?>" data-bs-toggle="modal" data-bs-target="#ForwardModel">Send</button>
            ...
            <button type="button" class="btn btn-danger" disabled>Reject</button>
              <button type="button" id="verify-button" class="btn btn-primary me-2" data-docuser ="<?php echo e($user->id); ?>" >Verify User Digital Signature </button>
              <?php endif; ?>
        </div>
    </div>
        ...
        if (otpValue) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    window.location.href = "<?php echo e(route('user-details-view')); ?>";
                } else {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u532655452/domains/eofficess.com/public_html/resources/views/user-profile/view_details_show.blade.php ENDPATH**/ ?>