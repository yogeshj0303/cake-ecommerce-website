                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        ...
                        <div class="flex-shrink-0">
                            <div class="hstack text-nowrap gap-2">
                                <button class="btn btn-soft-danger shadow-none" id="remove-actions" onClick="deleteMultiple()"><i
                    ...
                    <div class="position-relative d-inline-block">
                        <div class="avatar-md">
                            <div class="avatar-title bg-light rounded-circle shadow">
                                <img src="<?php echo e(URL::asset('build/images/brands/mail_chimp.png')); ?>" alt="" class="avatar-sm rounded-circle object-fit-cover">
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/e-office.acttconnect.com/resources/views/apps-crm-companies.blade.php ENDPATH**/ ?>